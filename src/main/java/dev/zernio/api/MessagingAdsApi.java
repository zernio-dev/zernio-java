...
public class MessagingAdsApi {
   ...
   */
  public CreateMessagingAd201Response createCallAd(@javax.annotation.Nonnull CreateCallAdRequest createCallAdRequest, @javax.annotation.Nullable String idempotencyKey) throws ApiException {
    return createCallAd(createCallAdRequest, idempotencyKey, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public CreateMessagingAd201Response createCallAd(@javax.annotation.Nonnull CreateCallAdRequest createCallAdRequest, @javax.annotation.Nullable String idempotencyKey, Map<String, String> headers) throws ApiException {
    ApiResponse<CreateMessagingAd201Response> localVarResponse = createCallAdWithHttpInfo(createCallAdRequest, idempotencyKey, headers);
   ...
   * @param createCallAdRequest  (required)
   * @param idempotencyKey Optional client-generated unique key (e.g. a UUID) that makes retries safe. Same key + same body replays the original response; same key + different body → 422; key still processing → 409. (optional)
   * @return ApiResponse&lt;CreateMessagingAd201Response&gt;
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<CreateMessagingAd201Response> createCallAdWithHttpInfo(@javax.annotation.Nonnull CreateCallAdRequest createCallAdRequest, @javax.annotation.Nullable String idempotencyKey) throws ApiException {
    return createCallAdWithHttpInfo(createCallAdRequest, idempotencyKey, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<CreateMessagingAd201Response> createCallAdWithHttpInfo(@javax.annotation.Nonnull CreateCallAdRequest createCallAdRequest, @javax.annotation.Nullable String idempotencyKey, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = createCallAdRequestBuilder(createCallAdRequest, idempotencyKey, headers);
    try {
      ...
      try {
        ...
        if (localVarResponseBody == null) {
          return new ApiResponse<CreateMessagingAd201Response>(
        ...
        CreateMessagingAd201Response responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<CreateMessagingAd201Response>() {});
  ...
  private HttpRequest.Builder createCallAdRequestBuilder(@javax.annotation.Nonnull CreateCallAdRequest createCallAdRequest, @javax.annotation.Nullable String idempotencyKey, Map<String, String> headers) throws ApiException {
   ...
   */
  @Deprecated
  public CreateMessagingAd201Response createCtwaAd(@javax.annotation.Nonnull CtwaAdRequestBody ctwaAdRequestBody, @javax.annotation.Nullable String idempotencyKey) throws ApiException {
    return createCtwaAd(ctwaAdRequestBody, idempotencyKey, null);
  }
   ...
   */
  @Deprecated
  public CreateMessagingAd201Response createCtwaAd(@javax.annotation.Nonnull CtwaAdRequestBody ctwaAdRequestBody, @javax.annotation.Nullable String idempotencyKey, Map<String, String> headers) throws ApiException {
    ApiResponse<CreateMessagingAd201Response> localVarResponse = createCtwaAdWithHttpInfo(ctwaAdRequestBody, idempotencyKey, headers);
    return localVarResponse.getData();
  }
   ...
   */
  @Deprecated
  public ApiResponse<CreateMessagingAd201Response> createCtwaAdWithHttpInfo(@javax.annotation.Nonnull CtwaAdRequestBody ctwaAdRequestBody, @javax.annotation.Nullable String idempotencyKey) throws ApiException {
    return createCtwaAdWithHttpInfo(ctwaAdRequestBody, idempotencyKey, null);
  }
   ...
   */
  @Deprecated
  public ApiResponse<CreateMessagingAd201Response> createCtwaAdWithHttpInfo(@javax.annotation.Nonnull CtwaAdRequestBody ctwaAdRequestBody, @javax.annotation.Nullable String idempotencyKey, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = createCtwaAdRequestBuilder(ctwaAdRequestBody, idempotencyKey, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder createCtwaAdRequestBuilder(@javax.annotation.Nonnull CtwaAdRequestBody ctwaAdRequestBody, @javax.annotation.Nullable String idempotencyKey, Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public CreateMessagingAd201Response createMessagingAd(@javax.annotation.Nonnull CreateMessagingAdRequest createMessagingAdRequest, @javax.annotation.Nullable String idempotencyKey) throws ApiException {
    return createMessagingAd(createMessagingAdRequest, idempotencyKey, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public CreateMessagingAd201Response createMessagingAd(@javax.annotation.Nonnull CreateMessagingAdRequest createMessagingAdRequest, @javax.annotation.Nullable String idempotencyKey, Map<String, String> headers) throws ApiException {
    ApiResponse<CreateMessagingAd201Response> localVarResponse = createMessagingAdWithHttpInfo(createMessagingAdRequest, idempotencyKey, headers);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<CreateMessagingAd201Response> createMessagingAdWithHttpInfo(@javax.annotation.Nonnull CreateMessagingAdRequest createMessagingAdRequest, @javax.annotation.Nullable String idempotencyKey) throws ApiException {
    return createMessagingAdWithHttpInfo(createMessagingAdRequest, idempotencyKey, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<CreateMessagingAd201Response> createMessagingAdWithHttpInfo(@javax.annotation.Nonnull CreateMessagingAdRequest createMessagingAdRequest, @javax.annotation.Nullable String idempotencyKey, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = createMessagingAdRequestBuilder(createMessagingAdRequest, idempotencyKey, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder createMessagingAdRequestBuilder(@javax.annotation.Nonnull CreateMessagingAdRequest createMessagingAdRequest, @javax.annotation.Nullable String idempotencyKey, Map<String, String> headers) throws ApiException {
