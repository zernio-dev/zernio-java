...
public class AnalyticsApi {
   ...
   * @param sortBy Sort by date, engagement, or a specific metric. Platform-specific metrics (follows, reposts, reels_skip_rate, ig_reels_*, completion_rate, profile_views, website_clicks) sort a null value as 0. (optional, default to date)
   ...
   * @param accountId Filter by account ID. Omit for all accounts. (optional)
   ...
   * @param fromDate Start date (YYYY-MM-DD). Defaults to 30 days ago. (optional)
   * @param toDate End date (YYYY-MM-DD). Defaults to today. (optional)
   * @param since Alias of fromDate, kept for existing callers (optional)
   * @param until Alias of toDate, kept for existing callers (optional)
   ...
   * @throws ApiException if fails to make API call
   */
  public InstagramAccountInsightsResponse getFacebookPageInsights(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate since, @javax.annotation.Nullable LocalDate until, @javax.annotation.Nullable String metricType) throws ApiException {
    return getFacebookPageInsights(accountId, metrics, fromDate, toDate, since, until, metricType, null);
  }
  ...
  public InstagramAccountInsightsResponse getFacebookPageInsights(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate since, @javax.annotation.Nullable LocalDate until, @javax.annotation.Nullable String metricType, Map<String, String> headers) throws ApiException {
    ApiResponse<InstagramAccountInsightsResponse> localVarResponse = getFacebookPageInsightsWithHttpInfo(accountId, metrics, fromDate, toDate, since, until, metricType, headers);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InstagramAccountInsightsResponse> getFacebookPageInsightsWithHttpInfo(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate since, @javax.annotation.Nullable LocalDate until, @javax.annotation.Nullable String metricType) throws ApiException {
    return getFacebookPageInsightsWithHttpInfo(accountId, metrics, fromDate, toDate, since, until, metricType, null);
  }
   ...
   */
  public ApiResponse<InstagramAccountInsightsResponse> getFacebookPageInsightsWithHttpInfo(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate since, @javax.annotation.Nullable LocalDate until, @javax.annotation.Nullable String metricType, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getFacebookPageInsightsRequestBuilder(accountId, metrics, fromDate, toDate, since, until, metricType, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder getFacebookPageInsightsRequestBuilder(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate since, @javax.annotation.Nullable LocalDate until, @javax.annotation.Nullable String metricType, Map<String, String> headers) throws ApiException {
   ...
   * @param accountId The Zernio SocialAccount ID for the connected Facebook Page. (required)
   * @param postId The platform post ID, exactly as returned in platformAnalytics[].platformPostId by /v1/analytics: \&quot;{pageId}_{postId}\&quot;, or the bare video ID for Reels.  (required)
   ...
   * @throws ApiException if fails to make API call
   */
  public FacebookPostEarningsResponse getFacebookPostEarnings(@javax.annotation.Nonnull String accountId, @javax.annotation.Nonnull String postId, @javax.annotation.Nullable String metrics) throws ApiException {
    return getFacebookPostEarnings(accountId, postId, metrics, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public FacebookPostEarningsResponse getFacebookPostEarnings(@javax.annotation.Nonnull String accountId, @javax.annotation.Nonnull String postId, @javax.annotation.Nullable String metrics, Map<String, String> headers) throws ApiException {
    ApiResponse<FacebookPostEarningsResponse> localVarResponse = getFacebookPostEarningsWithHttpInfo(accountId, postId, metrics, headers);
    return localVarResponse.getData();
  }
   ...
   * @param postId The platform post ID, exactly as returned in platformAnalytics[].platformPostId by /v1/analytics: \&quot;{pageId}_{postId}\&quot;, or the bare video ID for Reels.  (required)
   * @param metrics Comma-separated list of monetization metrics. Defaults to both:   - content_monetization_earnings   - monetization_approximate_earnings  content_monetization_earnings always carries unit \&quot;micro_amount\&quot; plus an ISO 4217 \&quot;currency\&quot;. monetization_approximate_earnings is always a bare number, so its unit is \&quot;unspecified\&quot; and its \&quot;currency\&quot; is null. The two are on different scales and are not comparable to each other. Any other metric name is rejected with 400.  (optional)
   * @return ApiResponse&lt;FacebookPostEarningsResponse&gt;
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<FacebookPostEarningsResponse> getFacebookPostEarningsWithHttpInfo(@javax.annotation.Nonnull String accountId, @javax.annotation.Nonnull String postId, @javax.annotation.Nullable String metrics) throws ApiException {
    return getFacebookPostEarningsWithHttpInfo(accountId, postId, metrics, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<FacebookPostEarningsResponse> getFacebookPostEarningsWithHttpInfo(@javax.annotation.Nonnull String accountId, @javax.annotation.Nonnull String postId, @javax.annotation.Nullable String metrics, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getFacebookPostEarningsRequestBuilder(accountId, postId, metrics, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("getFacebookPostEarnings", localVarResponse);
        }
        localVarResponseBody = ApiClient.getResponseBody(localVarResponse);
        if (localVarResponseBody == null) {
          return new ApiResponse<FacebookPostEarningsResponse>(
              localVarResponse.statusCode(),
              localVarResponse.headers().map(),
              null
          );
        ...
        String responseBody = new String(localVarResponseBody.readAllBytes());
        FacebookPostEarningsResponse responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<FacebookPostEarningsResponse>() {});
  ...
  private HttpRequest.Builder getFacebookPostEarningsRequestBuilder(@javax.annotation.Nonnull String accountId, @javax.annotation.Nonnull String postId, @javax.annotation.Nullable String metrics, Map<String, String> headers) throws ApiException {
    // verify the required parameter 'accountId' is set
    if (accountId == null) {
      throw new ApiException(400, "Missing the required parameter 'accountId' when calling getFacebookPostEarnings");
    }
    // verify the required parameter 'postId' is set
    if (postId == null) {
      throw new ApiException(400, "Missing the required parameter 'postId' when calling getFacebookPostEarnings");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v1/analytics/facebook/post-earnings";
   ...
   * @param fromDate Start date (YYYY-MM-DD). Defaults to 30 days ago. Max 18 months back. (optional)
   * @param toDate End date (YYYY-MM-DD). Defaults to today. (optional)
   * @param startDate Alias of fromDate, kept for existing callers (optional)
   * @param endDate Alias of toDate, kept for existing callers (optional)
   * @return GetGoogleBusinessPerformance200Response
   * @throws ApiException if fails to make API call
   */
  public GetGoogleBusinessPerformance200Response getGoogleBusinessPerformance(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate) throws ApiException {
    return getGoogleBusinessPerformance(accountId, metrics, fromDate, toDate, startDate, endDate, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public GetGoogleBusinessPerformance200Response getGoogleBusinessPerformance(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, Map<String, String> headers) throws ApiException {
    ApiResponse<GetGoogleBusinessPerformance200Response> localVarResponse = getGoogleBusinessPerformanceWithHttpInfo(accountId, metrics, fromDate, toDate, startDate, endDate, headers);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<GetGoogleBusinessPerformance200Response> getGoogleBusinessPerformanceWithHttpInfo(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate) throws ApiException {
    return getGoogleBusinessPerformanceWithHttpInfo(accountId, metrics, fromDate, toDate, startDate, endDate, null);
  }
   ...
   */
  public ApiResponse<GetGoogleBusinessPerformance200Response> getGoogleBusinessPerformanceWithHttpInfo(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getGoogleBusinessPerformanceRequestBuilder(accountId, metrics, fromDate, toDate, startDate, endDate, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder getGoogleBusinessPerformanceRequestBuilder(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, Map<String, String> headers) throws ApiException {
    // verify the required parameter 'accountId' is set
    if (accountId == null) {
  ...
  public InstagramAccountInsightsResponse getInstagramAccountInsights(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate since, @javax.annotation.Nullable LocalDate until, @javax.annotation.Nullable String metricType, @javax.annotation.Nullable String breakdown) throws ApiException {
    return getInstagramAccountInsights(accountId, metrics, fromDate, toDate, since, until, metricType, breakdown, null);
  }
  ...
  public InstagramAccountInsightsResponse getInstagramAccountInsights(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate since, @javax.annotation.Nullable LocalDate until, @javax.annotation.Nullable String metricType, @javax.annotation.Nullable String breakdown, Map<String, String> headers) throws ApiException {
    ApiResponse<InstagramAccountInsightsResponse> localVarResponse = getInstagramAccountInsightsWithHttpInfo(accountId, metrics, fromDate, toDate, since, until, metricType, breakdown, headers);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InstagramAccountInsightsResponse> getInstagramAccountInsightsWithHttpInfo(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate since, @javax.annotation.Nullable LocalDate until, @javax.annotation.Nullable String metricType, @javax.annotation.Nullable String breakdown) throws ApiException {
    return getInstagramAccountInsightsWithHttpInfo(accountId, metrics, fromDate, toDate, since, until, metricType, breakdown, null);
  }
   ...
   */
  public ApiResponse<InstagramAccountInsightsResponse> getInstagramAccountInsightsWithHttpInfo(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate since, @javax.annotation.Nullable LocalDate until, @javax.annotation.Nullable String metricType, @javax.annotation.Nullable String breakdown, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getInstagramAccountInsightsRequestBuilder(accountId, metrics, fromDate, toDate, since, until, metricType, breakdown, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder getInstagramAccountInsightsRequestBuilder(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate since, @javax.annotation.Nullable LocalDate until, @javax.annotation.Nullable String metricType, @javax.annotation.Nullable String breakdown, Map<String, String> headers) throws ApiException {
    // verify the required parameter 'accountId' is set
    if (accountId == null) {
  ...
  public InstagramAccountInsightsResponse getInstagramFollowerHistory(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate since, @javax.annotation.Nullable LocalDate until, @javax.annotation.Nullable String metricType) throws ApiException {
    return getInstagramFollowerHistory(accountId, metrics, fromDate, toDate, since, until, metricType, null);
  }
   ...
   */
  public InstagramAccountInsightsResponse getInstagramFollowerHistory(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate since, @javax.annotation.Nullable LocalDate until, @javax.annotation.Nullable String metricType, Map<String, String> headers) throws ApiException {
    ApiResponse<InstagramAccountInsightsResponse> localVarResponse = getInstagramFollowerHistoryWithHttpInfo(accountId, metrics, fromDate, toDate, since, until, metricType, headers);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InstagramAccountInsightsResponse> getInstagramFollowerHistoryWithHttpInfo(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate since, @javax.annotation.Nullable LocalDate until, @javax.annotation.Nullable String metricType) throws ApiException {
    return getInstagramFollowerHistoryWithHttpInfo(accountId, metrics, fromDate, toDate, since, until, metricType, null);
  }
   ...
   */
  public ApiResponse<InstagramAccountInsightsResponse> getInstagramFollowerHistoryWithHttpInfo(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate since, @javax.annotation.Nullable LocalDate until, @javax.annotation.Nullable String metricType, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getInstagramFollowerHistoryRequestBuilder(accountId, metrics, fromDate, toDate, since, until, metricType, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder getInstagramFollowerHistoryRequestBuilder(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate since, @javax.annotation.Nullable LocalDate until, @javax.annotation.Nullable String metricType, Map<String, String> headers) throws ApiException {
    // verify the required parameter 'accountId' is set
    if (accountId == null) {
   ...
   * @param fromDate Start date (YYYY-MM-DD). If omitted, returns lifetime analytics. (optional)
   * @param toDate End date (YYYY-MM-DD, exclusive). Defaults to today if omitted. (optional)
   * @param startDate Alias of fromDate, kept for existing callers (optional)
   * @param endDate Alias of toDate, kept for existing callers (optional)
   ...
   * @throws ApiException if fails to make API call
   */
  public GetLinkedInAggregateAnalytics200Response getLinkedInAggregateAnalytics(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String aggregation, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String metrics) throws ApiException {
    return getLinkedInAggregateAnalytics(accountId, aggregation, fromDate, toDate, startDate, endDate, metrics, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public GetLinkedInAggregateAnalytics200Response getLinkedInAggregateAnalytics(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String aggregation, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String metrics, Map<String, String> headers) throws ApiException {
    ApiResponse<GetLinkedInAggregateAnalytics200Response> localVarResponse = getLinkedInAggregateAnalyticsWithHttpInfo(accountId, aggregation, fromDate, toDate, startDate, endDate, metrics, headers);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<GetLinkedInAggregateAnalytics200Response> getLinkedInAggregateAnalyticsWithHttpInfo(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String aggregation, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String metrics) throws ApiException {
    return getLinkedInAggregateAnalyticsWithHttpInfo(accountId, aggregation, fromDate, toDate, startDate, endDate, metrics, null);
  }
   ...
   */
  public ApiResponse<GetLinkedInAggregateAnalytics200Response> getLinkedInAggregateAnalyticsWithHttpInfo(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String aggregation, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String metrics, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getLinkedInAggregateAnalyticsRequestBuilder(accountId, aggregation, fromDate, toDate, startDate, endDate, metrics, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder getLinkedInAggregateAnalyticsRequestBuilder(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String aggregation, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, @javax.annotation.Nullable String metrics, Map<String, String> headers) throws ApiException {
    // verify the required parameter 'accountId' is set
    if (accountId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public InstagramAccountInsightsResponse getLinkedInOrgAggregateAnalytics(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate since, @javax.annotation.Nullable LocalDate until, @javax.annotation.Nullable String metricType) throws ApiException {
    return getLinkedInOrgAggregateAnalytics(accountId, metrics, fromDate, toDate, since, until, metricType, null);
  }
   ...
   */
  public InstagramAccountInsightsResponse getLinkedInOrgAggregateAnalytics(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate since, @javax.annotation.Nullable LocalDate until, @javax.annotation.Nullable String metricType, Map<String, String> headers) throws ApiException {
    ApiResponse<InstagramAccountInsightsResponse> localVarResponse = getLinkedInOrgAggregateAnalyticsWithHttpInfo(accountId, metrics, fromDate, toDate, since, until, metricType, headers);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InstagramAccountInsightsResponse> getLinkedInOrgAggregateAnalyticsWithHttpInfo(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate since, @javax.annotation.Nullable LocalDate until, @javax.annotation.Nullable String metricType) throws ApiException {
    return getLinkedInOrgAggregateAnalyticsWithHttpInfo(accountId, metrics, fromDate, toDate, since, until, metricType, null);
  }
   ...
   */
  public ApiResponse<InstagramAccountInsightsResponse> getLinkedInOrgAggregateAnalyticsWithHttpInfo(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate since, @javax.annotation.Nullable LocalDate until, @javax.annotation.Nullable String metricType, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getLinkedInOrgAggregateAnalyticsRequestBuilder(accountId, metrics, fromDate, toDate, since, until, metricType, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder getLinkedInOrgAggregateAnalyticsRequestBuilder(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate since, @javax.annotation.Nullable LocalDate until, @javax.annotation.Nullable String metricType, Map<String, String> headers) throws ApiException {
    // verify the required parameter 'accountId' is set
    if (accountId == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public InstagramAccountInsightsResponse getTikTokAccountInsights(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate since, @javax.annotation.Nullable LocalDate until, @javax.annotation.Nullable String metricType) throws ApiException {
    return getTikTokAccountInsights(accountId, metrics, fromDate, toDate, since, until, metricType, null);
  }
   ...
   */
  public InstagramAccountInsightsResponse getTikTokAccountInsights(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate since, @javax.annotation.Nullable LocalDate until, @javax.annotation.Nullable String metricType, Map<String, String> headers) throws ApiException {
    ApiResponse<InstagramAccountInsightsResponse> localVarResponse = getTikTokAccountInsightsWithHttpInfo(accountId, metrics, fromDate, toDate, since, until, metricType, headers);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InstagramAccountInsightsResponse> getTikTokAccountInsightsWithHttpInfo(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate since, @javax.annotation.Nullable LocalDate until, @javax.annotation.Nullable String metricType) throws ApiException {
    return getTikTokAccountInsightsWithHttpInfo(accountId, metrics, fromDate, toDate, since, until, metricType, null);
  }
   ...
   */
  public ApiResponse<InstagramAccountInsightsResponse> getTikTokAccountInsightsWithHttpInfo(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate since, @javax.annotation.Nullable LocalDate until, @javax.annotation.Nullable String metricType, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getTikTokAccountInsightsRequestBuilder(accountId, metrics, fromDate, toDate, since, until, metricType, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
   ...
   * @param fromDate Start date (YYYY-MM-DD). Defaults to 30 days ago. (optional)
   * @param toDate End date (YYYY-MM-DD). Defaults to today. YouTube Analytics has a 2-3 day delay, so the fetch is internally clamped to 3 days ago; any requested range extending beyond that returns zero values for the tail days. The response&#39;s dateRange.until field reflects your requested value.  (optional)
   * @param since Alias of fromDate, kept for existing callers (optional)
   * @param until Alias of toDate, kept for existing callers (optional)
   ...
   * @throws ApiException if fails to make API call
   */
  public InstagramAccountInsightsResponse getYouTubeChannelInsights(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate since, @javax.annotation.Nullable LocalDate until, @javax.annotation.Nullable String metricType) throws ApiException {
    return getYouTubeChannelInsights(accountId, metrics, fromDate, toDate, since, until, metricType, null);
  }
   ...
   */
  public InstagramAccountInsightsResponse getYouTubeChannelInsights(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate since, @javax.annotation.Nullable LocalDate until, @javax.annotation.Nullable String metricType, Map<String, String> headers) throws ApiException {
    ApiResponse<InstagramAccountInsightsResponse> localVarResponse = getYouTubeChannelInsightsWithHttpInfo(accountId, metrics, fromDate, toDate, since, until, metricType, headers);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InstagramAccountInsightsResponse> getYouTubeChannelInsightsWithHttpInfo(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate since, @javax.annotation.Nullable LocalDate until, @javax.annotation.Nullable String metricType) throws ApiException {
    return getYouTubeChannelInsightsWithHttpInfo(accountId, metrics, fromDate, toDate, since, until, metricType, null);
  }
   ...
   */
  public ApiResponse<InstagramAccountInsightsResponse> getYouTubeChannelInsightsWithHttpInfo(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate since, @javax.annotation.Nullable LocalDate until, @javax.annotation.Nullable String metricType, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getYouTubeChannelInsightsRequestBuilder(accountId, metrics, fromDate, toDate, since, until, metricType, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder getYouTubeChannelInsightsRequestBuilder(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String metrics, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate since, @javax.annotation.Nullable LocalDate until, @javax.annotation.Nullable String metricType, Map<String, String> headers) throws ApiException {
    // verify the required parameter 'accountId' is set
    if (accountId == null) {
   ...
   * @param fromDate Start date (YYYY-MM-DD). Defaults to 30 days ago. (optional)
   * @param toDate End date (YYYY-MM-DD). Defaults to 3 days ago, the newest fully finalized day (YouTube finalizes analytics with a ~3-day delay). An explicit toDate is honored up to today: days inside the delay window are provisional and may still be revised by YouTube (see provisionalSince in the response), and days YouTube has not processed yet are omitted from dailyViews.  (optional)
   * @param startDate Alias of fromDate, kept for existing callers (optional)
   * @param endDate Alias of toDate, kept for existing callers (optional)
   * @return YouTubeDailyViewsResponse
   * @throws ApiException if fails to make API call
   */
  public YouTubeDailyViewsResponse getYouTubeDailyViews(@javax.annotation.Nonnull String videoId, @javax.annotation.Nonnull String accountId, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate) throws ApiException {
    return getYouTubeDailyViews(videoId, accountId, fromDate, toDate, startDate, endDate, null);
  }
   ...
   */
  public YouTubeDailyViewsResponse getYouTubeDailyViews(@javax.annotation.Nonnull String videoId, @javax.annotation.Nonnull String accountId, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, Map<String, String> headers) throws ApiException {
    ApiResponse<YouTubeDailyViewsResponse> localVarResponse = getYouTubeDailyViewsWithHttpInfo(videoId, accountId, fromDate, toDate, startDate, endDate, headers);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<YouTubeDailyViewsResponse> getYouTubeDailyViewsWithHttpInfo(@javax.annotation.Nonnull String videoId, @javax.annotation.Nonnull String accountId, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate) throws ApiException {
    return getYouTubeDailyViewsWithHttpInfo(videoId, accountId, fromDate, toDate, startDate, endDate, null);
  }
   ...
   */
  public ApiResponse<YouTubeDailyViewsResponse> getYouTubeDailyViewsWithHttpInfo(@javax.annotation.Nonnull String videoId, @javax.annotation.Nonnull String accountId, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getYouTubeDailyViewsRequestBuilder(videoId, accountId, fromDate, toDate, startDate, endDate, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder getYouTubeDailyViewsRequestBuilder(@javax.annotation.Nonnull String videoId, @javax.annotation.Nonnull String accountId, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, Map<String, String> headers) throws ApiException {
   ...
   * @param fromDate Start date in YYYY-MM-DD format. Defaults to 90 days ago, or to the video&#39;s publish date (lifetime) when videoId is provided.  (optional)
   * @param toDate End date (YYYY-MM-DD). Defaults to 3 days ago, the newest fully finalized day (YouTube finalizes analytics with a ~3-day delay). An explicit toDate is honored up to today: days inside the delay window are provisional and may still be revised by YouTube (see provisionalSince in the response).  (optional)
   * @param startDate Alias of fromDate, kept for existing callers (optional)
   * @param endDate Alias of toDate, kept for existing callers (optional)
   * @return YouTubeDemographicsResponse
   * @throws ApiException if fails to make API call
   */
  public YouTubeDemographicsResponse getYouTubeDemographics(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String videoId, @javax.annotation.Nullable String breakdown, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate) throws ApiException {
    return getYouTubeDemographics(accountId, videoId, breakdown, fromDate, toDate, startDate, endDate, null);
  }
   ...
   */
  public YouTubeDemographicsResponse getYouTubeDemographics(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String videoId, @javax.annotation.Nullable String breakdown, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, Map<String, String> headers) throws ApiException {
    ApiResponse<YouTubeDemographicsResponse> localVarResponse = getYouTubeDemographicsWithHttpInfo(accountId, videoId, breakdown, fromDate, toDate, startDate, endDate, headers);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<YouTubeDemographicsResponse> getYouTubeDemographicsWithHttpInfo(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String videoId, @javax.annotation.Nullable String breakdown, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate) throws ApiException {
    return getYouTubeDemographicsWithHttpInfo(accountId, videoId, breakdown, fromDate, toDate, startDate, endDate, null);
  }
   ...
   */
  public ApiResponse<YouTubeDemographicsResponse> getYouTubeDemographicsWithHttpInfo(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String videoId, @javax.annotation.Nullable String breakdown, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getYouTubeDemographicsRequestBuilder(accountId, videoId, breakdown, fromDate, toDate, startDate, endDate, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder getYouTubeDemographicsRequestBuilder(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String videoId, @javax.annotation.Nullable String breakdown, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, Map<String, String> headers) throws ApiException {
    // verify the required parameter 'accountId' is set
    if (accountId == null) {
   ...
   * @param videoId The YouTube video ID (e.g., \&quot;dQw4w9WgXcQ\&quot;) (required)
   * @param accountId The Zernio account ID for the YouTube account (required)
   * @param fromDate Start date (YYYY-MM-DD). Defaults to the video&#39;s publish date (lifetime curve). (optional)
   * @param toDate End date (YYYY-MM-DD). Defaults to 3 days ago, the newest fully finalized day (YouTube finalizes analytics with a ~3-day delay). An explicit toDate is honored up to today: days inside the delay window are provisional and may still be revised by YouTube (see provisionalSince in the response).  (optional)
   * @param startDate Alias of fromDate, kept for existing callers (optional)
   * @param endDate Alias of toDate, kept for existing callers (optional)
   ...
   * @throws ApiException if fails to make API call
   */
  public YouTubeVideoRetentionResponse getYouTubeVideoRetention(@javax.annotation.Nonnull String videoId, @javax.annotation.Nonnull String accountId, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate) throws ApiException {
    return getYouTubeVideoRetention(videoId, accountId, fromDate, toDate, startDate, endDate, null);
  }
   ...
   */
  public YouTubeVideoRetentionResponse getYouTubeVideoRetention(@javax.annotation.Nonnull String videoId, @javax.annotation.Nonnull String accountId, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, Map<String, String> headers) throws ApiException {
    ApiResponse<YouTubeVideoRetentionResponse> localVarResponse = getYouTubeVideoRetentionWithHttpInfo(videoId, accountId, fromDate, toDate, startDate, endDate, headers);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<YouTubeVideoRetentionResponse> getYouTubeVideoRetentionWithHttpInfo(@javax.annotation.Nonnull String videoId, @javax.annotation.Nonnull String accountId, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate) throws ApiException {
    return getYouTubeVideoRetentionWithHttpInfo(videoId, accountId, fromDate, toDate, startDate, endDate, null);
  }
   ...
   */
  public ApiResponse<YouTubeVideoRetentionResponse> getYouTubeVideoRetentionWithHttpInfo(@javax.annotation.Nonnull String videoId, @javax.annotation.Nonnull String accountId, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getYouTubeVideoRetentionRequestBuilder(videoId, accountId, fromDate, toDate, startDate, endDate, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder getYouTubeVideoRetentionRequestBuilder(@javax.annotation.Nonnull String videoId, @javax.annotation.Nonnull String accountId, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate startDate, @javax.annotation.Nullable LocalDate endDate, Map<String, String> headers) throws ApiException {
    // verify the required parameter 'videoId' is set
    if (videoId == null) {
