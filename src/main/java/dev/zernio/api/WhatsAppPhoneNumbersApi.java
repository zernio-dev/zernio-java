...
public class WhatsAppPhoneNumbersApi {
   ...
   * @param prefix Alias of areaCode, kept for existing callers (optional)
   ...
   */
  @Deprecated
  public SearchAvailableWhatsAppNumbers200Response searchAvailableWhatsAppNumbers(@javax.annotation.Nullable String country, @javax.annotation.Nullable String numberType, @javax.annotation.Nullable String areaCode, @javax.annotation.Nullable String type, @javax.annotation.Nullable String prefix, @javax.annotation.Nullable String locality, @javax.annotation.Nullable String contains, @javax.annotation.Nullable Integer limit) throws ApiException {
    return searchAvailableWhatsAppNumbers(country, numberType, areaCode, type, prefix, locality, contains, limit, null);
  }
   ...
   */
  @Deprecated
  public SearchAvailableWhatsAppNumbers200Response searchAvailableWhatsAppNumbers(@javax.annotation.Nullable String country, @javax.annotation.Nullable String numberType, @javax.annotation.Nullable String areaCode, @javax.annotation.Nullable String type, @javax.annotation.Nullable String prefix, @javax.annotation.Nullable String locality, @javax.annotation.Nullable String contains, @javax.annotation.Nullable Integer limit, Map<String, String> headers) throws ApiException {
    ApiResponse<SearchAvailableWhatsAppNumbers200Response> localVarResponse = searchAvailableWhatsAppNumbersWithHttpInfo(country, numberType, areaCode, type, prefix, locality, contains, limit, headers);
    return localVarResponse.getData();
  }
   ...
   */
  @Deprecated
  public ApiResponse<SearchAvailableWhatsAppNumbers200Response> searchAvailableWhatsAppNumbersWithHttpInfo(@javax.annotation.Nullable String country, @javax.annotation.Nullable String numberType, @javax.annotation.Nullable String areaCode, @javax.annotation.Nullable String type, @javax.annotation.Nullable String prefix, @javax.annotation.Nullable String locality, @javax.annotation.Nullable String contains, @javax.annotation.Nullable Integer limit) throws ApiException {
    return searchAvailableWhatsAppNumbersWithHttpInfo(country, numberType, areaCode, type, prefix, locality, contains, limit, null);
  }
   ...
   */
  @Deprecated
  public ApiResponse<SearchAvailableWhatsAppNumbers200Response> searchAvailableWhatsAppNumbersWithHttpInfo(@javax.annotation.Nullable String country, @javax.annotation.Nullable String numberType, @javax.annotation.Nullable String areaCode, @javax.annotation.Nullable String type, @javax.annotation.Nullable String prefix, @javax.annotation.Nullable String locality, @javax.annotation.Nullable String contains, @javax.annotation.Nullable Integer limit, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = searchAvailableWhatsAppNumbersRequestBuilder(country, numberType, areaCode, type, prefix, locality, contains, limit, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder searchAvailableWhatsAppNumbersRequestBuilder(@javax.annotation.Nullable String country, @javax.annotation.Nullable String numberType, @javax.annotation.Nullable String areaCode, @javax.annotation.Nullable String type, @javax.annotation.Nullable String prefix, @javax.annotation.Nullable String locality, @javax.annotation.Nullable String contains, @javax.annotation.Nullable Integer limit, Map<String, String> headers) throws ApiException {
    ...
    localVarQueryParameterBaseName = "numberType";
    localVarQueryParams.addAll(ApiClient.parameterToPairs("numberType", numberType));
    localVarQueryParameterBaseName = "areaCode";
