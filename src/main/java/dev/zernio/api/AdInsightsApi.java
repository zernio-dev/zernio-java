...
public class AdInsightsApi {
  ...
  public GetAdsSearchTerms200Response getAdsSearchTerms(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String customerId, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable String campaignId, @javax.annotation.Nullable String adSetId, @javax.annotation.Nullable String adGroupId, @javax.annotation.Nullable String pageToken) throws ApiException {
    return getAdsSearchTerms(accountId, customerId, fromDate, toDate, campaignId, adSetId, adGroupId, pageToken, null);
  }
  ...
  public GetAdsSearchTerms200Response getAdsSearchTerms(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String customerId, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable String campaignId, @javax.annotation.Nullable String adSetId, @javax.annotation.Nullable String adGroupId, @javax.annotation.Nullable String pageToken, Map<String, String> headers) throws ApiException {
    ApiResponse<GetAdsSearchTerms200Response> localVarResponse = getAdsSearchTermsWithHttpInfo(accountId, customerId, fromDate, toDate, campaignId, adSetId, adGroupId, pageToken, headers);
    return localVarResponse.getData();
  }
  ...
  public ApiResponse<GetAdsSearchTerms200Response> getAdsSearchTermsWithHttpInfo(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String customerId, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable String campaignId, @javax.annotation.Nullable String adSetId, @javax.annotation.Nullable String adGroupId, @javax.annotation.Nullable String pageToken) throws ApiException {
    return getAdsSearchTermsWithHttpInfo(accountId, customerId, fromDate, toDate, campaignId, adSetId, adGroupId, pageToken, null);
  }
   ...
   */
  public ApiResponse<GetAdsSearchTerms200Response> getAdsSearchTermsWithHttpInfo(@javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String customerId, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable String campaignId, @javax.annotation.Nullable String adSetId, @javax.annotation.Nullable String adGroupId, @javax.annotation.Nullable String pageToken, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getAdsSearchTermsRequestBuilder(accountId, customerId, fromDate, toDate, campaignId, adSetId, adGroupId, pageToken, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
