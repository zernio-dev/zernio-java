...
public class PhoneNumbersApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public CheckPhoneNumberAvailability200Response checkPhoneNumberAvailability(@javax.annotation.Nonnull String country, @javax.annotation.Nullable String numberType, @javax.annotation.Nullable Boolean sms) throws ApiException {
    return checkPhoneNumberAvailability(country, numberType, sms, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public CheckPhoneNumberAvailability200Response checkPhoneNumberAvailability(@javax.annotation.Nonnull String country, @javax.annotation.Nullable String numberType, @javax.annotation.Nullable Boolean sms, Map<String, String> headers) throws ApiException {
    ApiResponse<CheckPhoneNumberAvailability200Response> localVarResponse = checkPhoneNumberAvailabilityWithHttpInfo(country, numberType, sms, headers);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<CheckPhoneNumberAvailability200Response> checkPhoneNumberAvailabilityWithHttpInfo(@javax.annotation.Nonnull String country, @javax.annotation.Nullable String numberType, @javax.annotation.Nullable Boolean sms) throws ApiException {
    return checkPhoneNumberAvailabilityWithHttpInfo(country, numberType, sms, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<CheckPhoneNumberAvailability200Response> checkPhoneNumberAvailabilityWithHttpInfo(@javax.annotation.Nonnull String country, @javax.annotation.Nullable String numberType, @javax.annotation.Nullable Boolean sms, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = checkPhoneNumberAvailabilityRequestBuilder(country, numberType, sms, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder checkPhoneNumberAvailabilityRequestBuilder(@javax.annotation.Nonnull String country, @javax.annotation.Nullable String numberType, @javax.annotation.Nullable Boolean sms, Map<String, String> headers) throws ApiException {
   ...
   * @param numberType Requirements and reuse eligibility are per (country, type). Omitted &#x3D; the country&#39;s default type. Pass the same value on the POST. (optional)
   * @return GetPhoneNumberKycForm200Response
   * @throws ApiException if fails to make API call
   */
  public GetPhoneNumberKycForm200Response getPhoneNumberKycForm(@javax.annotation.Nonnull String country, @javax.annotation.Nullable String numberType) throws ApiException {
    return getPhoneNumberKycForm(country, numberType, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public GetPhoneNumberKycForm200Response getPhoneNumberKycForm(@javax.annotation.Nonnull String country, @javax.annotation.Nullable String numberType, Map<String, String> headers) throws ApiException {
    ApiResponse<GetPhoneNumberKycForm200Response> localVarResponse = getPhoneNumberKycFormWithHttpInfo(country, numberType, headers);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<GetPhoneNumberKycForm200Response> getPhoneNumberKycFormWithHttpInfo(@javax.annotation.Nonnull String country, @javax.annotation.Nullable String numberType) throws ApiException {
    return getPhoneNumberKycFormWithHttpInfo(country, numberType, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<GetPhoneNumberKycForm200Response> getPhoneNumberKycFormWithHttpInfo(@javax.annotation.Nonnull String country, @javax.annotation.Nullable String numberType, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getPhoneNumberKycFormRequestBuilder(country, numberType, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder getPhoneNumberKycFormRequestBuilder(@javax.annotation.Nonnull String country, @javax.annotation.Nullable String numberType, Map<String, String> headers) throws ApiException {
    // verify the required parameter 'country' is set
    if (country == null) {
   ...
   * @param documentId The Telnyx document id (from &#x60;reusable.options[].details[].documentId&#x60;). (required)
   * @return File
   * @throws ApiException if fails to make API call
   */
  public File viewPhoneNumberKycDocument(@javax.annotation.Nonnull String documentId) throws ApiException {
    return viewPhoneNumberKycDocument(documentId, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public File viewPhoneNumberKycDocument(@javax.annotation.Nonnull String documentId, Map<String, String> headers) throws ApiException {
    ApiResponse<File> localVarResponse = viewPhoneNumberKycDocumentWithHttpInfo(documentId, headers);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> viewPhoneNumberKycDocumentWithHttpInfo(@javax.annotation.Nonnull String documentId) throws ApiException {
    return viewPhoneNumberKycDocumentWithHttpInfo(documentId, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> viewPhoneNumberKycDocumentWithHttpInfo(@javax.annotation.Nonnull String documentId, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = viewPhoneNumberKycDocumentRequestBuilder(documentId, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("viewPhoneNumberKycDocument", localVarResponse);
        }
        localVarResponseBody = ApiClient.getResponseBody(localVarResponse);
        if (localVarResponseBody == null) {
  ...
  private HttpRequest.Builder viewPhoneNumberKycDocumentRequestBuilder(@javax.annotation.Nonnull String documentId, Map<String, String> headers) throws ApiException {
    // verify the required parameter 'documentId' is set
    if (documentId == null) {
      throw new ApiException(400, "Missing the required parameter 'documentId' when calling viewPhoneNumberKycDocument");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v1/phone-numbers/kyc/document/{documentId}"
