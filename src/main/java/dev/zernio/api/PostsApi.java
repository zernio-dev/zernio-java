...
import dev.zernio.model.PostPublishIncompleteResponse;
...
import dev.zernio.model.RetryPost207Response;
...
public class PostsApi {
   ...
   * @param xRequestId Optional client-generated request identifier. A request with the same value as an earlier one within 24 hours that also matches its content fingerprint (same account, content and media URLs) returns the original post (HTTP 200) instead of a duplicate-content 409. It does not protect a retry whose body differs; use &#x60;Idempotency-Key&#x60; for that. SDKs set it automatically. See the operation description for the full idempotency contract.  (optional)
   * @return CreatePost200Response
   * @throws ApiException if fails to make API call
   */
  public CreatePost200Response createPost(@javax.annotation.Nonnull CreatePostRequest createPostRequest, @javax.annotation.Nullable String idempotencyKey, @javax.annotation.Nullable UUID xRequestId) throws ApiException {
    return createPost(createPostRequest, idempotencyKey, xRequestId, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public CreatePost200Response createPost(@javax.annotation.Nonnull CreatePostRequest createPostRequest, @javax.annotation.Nullable String idempotencyKey, @javax.annotation.Nullable UUID xRequestId, Map<String, String> headers) throws ApiException {
    ApiResponse<CreatePost200Response> localVarResponse = createPostWithHttpInfo(createPostRequest, idempotencyKey, xRequestId, headers);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<CreatePost200Response> createPostWithHttpInfo(@javax.annotation.Nonnull CreatePostRequest createPostRequest, @javax.annotation.Nullable String idempotencyKey, @javax.annotation.Nullable UUID xRequestId) throws ApiException {
    return createPostWithHttpInfo(createPostRequest, idempotencyKey, xRequestId, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<CreatePost200Response> createPostWithHttpInfo(@javax.annotation.Nonnull CreatePostRequest createPostRequest, @javax.annotation.Nullable String idempotencyKey, @javax.annotation.Nullable UUID xRequestId, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = createPostRequestBuilder(createPostRequest, idempotencyKey, xRequestId, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder createPostRequestBuilder(@javax.annotation.Nonnull CreatePostRequest createPostRequest, @javax.annotation.Nullable String idempotencyKey, @javax.annotation.Nullable UUID xRequestId, Map<String, String> headers) throws ApiException {
    ...
    if (xRequestId != null) {
      localVarRequestBuilder.header("x-request-id", xRequestId.toString());
    }
   ...
   * @param offset Row offset. Takes precedence over page when both are sent; the response pagination.page is derived from it. (optional)
   ...
   * @param fromDate Zero-padded YYYY-MM-DD, or a full ISO 8601 datetime. An empty value means no date filter; any other malformed value returns 400. The same name the other date-window filters use (ads, analytics). (optional)
   * @param toDate Zero-padded YYYY-MM-DD, or a full ISO 8601 datetime. An empty value means no date filter; any other malformed value returns 400. The same name the other date-window filters use (ads, analytics). (optional)
   * @param dateFrom Alias of fromDate, kept for existing callers (optional)
   * @param dateTo Alias of toDate, kept for existing callers (optional)
   ...
   * @param accountId Filter posts to those published via a specific account (24-char hex ObjectId). (optional)
   * @return PostsListResponse
   * @throws ApiException if fails to make API call
   */
  public PostsListResponse listPosts(@javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, @javax.annotation.Nullable String source, @javax.annotation.Nullable String status, @javax.annotation.Nullable String platform, @javax.annotation.Nullable String profileId, @javax.annotation.Nullable String createdBy, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate dateFrom, @javax.annotation.Nullable LocalDate dateTo, @javax.annotation.Nullable Boolean includeHidden, @javax.annotation.Nullable String search, @javax.annotation.Nullable String sortBy, @javax.annotation.Nullable String accountId) throws ApiException {
    return listPosts(page, limit, offset, source, status, platform, profileId, createdBy, fromDate, toDate, dateFrom, dateTo, includeHidden, search, sortBy, accountId, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public PostsListResponse listPosts(@javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, @javax.annotation.Nullable String source, @javax.annotation.Nullable String status, @javax.annotation.Nullable String platform, @javax.annotation.Nullable String profileId, @javax.annotation.Nullable String createdBy, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate dateFrom, @javax.annotation.Nullable LocalDate dateTo, @javax.annotation.Nullable Boolean includeHidden, @javax.annotation.Nullable String search, @javax.annotation.Nullable String sortBy, @javax.annotation.Nullable String accountId, Map<String, String> headers) throws ApiException {
    ApiResponse<PostsListResponse> localVarResponse = listPostsWithHttpInfo(page, limit, offset, source, status, platform, profileId, createdBy, fromDate, toDate, dateFrom, dateTo, includeHidden, search, sortBy, accountId, headers);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PostsListResponse> listPostsWithHttpInfo(@javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, @javax.annotation.Nullable String source, @javax.annotation.Nullable String status, @javax.annotation.Nullable String platform, @javax.annotation.Nullable String profileId, @javax.annotation.Nullable String createdBy, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate dateFrom, @javax.annotation.Nullable LocalDate dateTo, @javax.annotation.Nullable Boolean includeHidden, @javax.annotation.Nullable String search, @javax.annotation.Nullable String sortBy, @javax.annotation.Nullable String accountId) throws ApiException {
    return listPostsWithHttpInfo(page, limit, offset, source, status, platform, profileId, createdBy, fromDate, toDate, dateFrom, dateTo, includeHidden, search, sortBy, accountId, null);
  }
   ...
   */
  public ApiResponse<PostsListResponse> listPostsWithHttpInfo(@javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, @javax.annotation.Nullable String source, @javax.annotation.Nullable String status, @javax.annotation.Nullable String platform, @javax.annotation.Nullable String profileId, @javax.annotation.Nullable String createdBy, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate dateFrom, @javax.annotation.Nullable LocalDate dateTo, @javax.annotation.Nullable Boolean includeHidden, @javax.annotation.Nullable String search, @javax.annotation.Nullable String sortBy, @javax.annotation.Nullable String accountId, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = listPostsRequestBuilder(page, limit, offset, source, status, platform, profileId, createdBy, fromDate, toDate, dateFrom, dateTo, includeHidden, search, sortBy, accountId, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder listPostsRequestBuilder(@javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, @javax.annotation.Nullable String source, @javax.annotation.Nullable String status, @javax.annotation.Nullable String platform, @javax.annotation.Nullable String profileId, @javax.annotation.Nullable String createdBy, @javax.annotation.Nullable LocalDate fromDate, @javax.annotation.Nullable LocalDate toDate, @javax.annotation.Nullable LocalDate dateFrom, @javax.annotation.Nullable LocalDate dateTo, @javax.annotation.Nullable Boolean includeHidden, @javax.annotation.Nullable String search, @javax.annotation.Nullable String sortBy, @javax.annotation.Nullable String accountId, Map<String, String> headers) throws ApiException {
