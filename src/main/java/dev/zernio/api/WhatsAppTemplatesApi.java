...
public class WhatsAppTemplatesApi {
    ...
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("getWhatsAppLibraryTemplate", localVarResponse);
        }
        localVarResponseBody = ApiClient.getResponseBody(localVarResponse);
        if (localVarResponseBody == null) {
          return new ApiResponse<GetWhatsAppLibraryTemplate200Response>(
        ...
        GetWhatsAppLibraryTemplate200Response responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<GetWhatsAppLibraryTemplate200Response>() {});
  ...
  private HttpRequest.Builder getWhatsAppLibraryTemplateRequestBuilder(@javax.annotation.Nonnull String accountId, @javax.annotation.Nonnull String name, @javax.annotation.Nullable String language, Map<String, String> headers) throws ApiException {
    ...
    if (name == null) {
      throw new ApiException(400, "Missing the required parameter 'name' when calling getWhatsAppLibraryTemplate");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/v1/whatsapp/template-library";
