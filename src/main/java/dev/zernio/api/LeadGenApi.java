...
import dev.zernio.model.DeleteTestLead200Response;
...
public class LeadGenApi {
   ...
   * @param accountId Connected Meta ads, facebook or linkedin ads account id (selects the platform). A Meta ads connection resolves its Page through the Facebook account linked to the same profile. (required)
   ...
   * @param formId  (required)
   * @param accountId The facebook or metaads account whose Page owns the form. (required)
   * @param leadId The test lead id returned by createTestLead (or shown in the Testing Tool). Omitted &#x3D; the test lead currently on the form. (optional)
   * @return DeleteTestLead200Response
   * @throws ApiException if fails to make API call
   */
  public DeleteTestLead200Response deleteTestLead(@javax.annotation.Nonnull String formId, @javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String leadId) throws ApiException {
    return deleteTestLead(formId, accountId, leadId, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public DeleteTestLead200Response deleteTestLead(@javax.annotation.Nonnull String formId, @javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String leadId, Map<String, String> headers) throws ApiException {
    ApiResponse<DeleteTestLead200Response> localVarResponse = deleteTestLeadWithHttpInfo(formId, accountId, leadId, headers);
    return localVarResponse.getData();
  }
   ...
   * @param accountId The facebook or metaads account whose Page owns the form. (required)
   * @param leadId The test lead id returned by createTestLead (or shown in the Testing Tool). Omitted &#x3D; the test lead currently on the form. (optional)
   * @return ApiResponse&lt;DeleteTestLead200Response&gt;
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<DeleteTestLead200Response> deleteTestLeadWithHttpInfo(@javax.annotation.Nonnull String formId, @javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String leadId) throws ApiException {
    return deleteTestLeadWithHttpInfo(formId, accountId, leadId, null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<DeleteTestLead200Response> deleteTestLeadWithHttpInfo(@javax.annotation.Nonnull String formId, @javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String leadId, Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = deleteTestLeadRequestBuilder(formId, accountId, leadId, headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("deleteTestLead", localVarResponse);
        }
        localVarResponseBody = ApiClient.getResponseBody(localVarResponse);
        if (localVarResponseBody == null) {
          return new ApiResponse<DeleteTestLead200Response>(
              localVarResponse.statusCode(),
              localVarResponse.headers().map(),
              null
          );
        ...
        String responseBody = new String(localVarResponseBody.readAllBytes());
        DeleteTestLead200Response responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<DeleteTestLead200Response>() {});
  ...
  private HttpRequest.Builder deleteTestLeadRequestBuilder(@javax.annotation.Nonnull String formId, @javax.annotation.Nonnull String accountId, @javax.annotation.Nullable String leadId, Map<String, String> headers) throws ApiException {
    // verify the required parameter 'formId' is set
    if (formId == null) {
      throw new ApiException(400, "Missing the required parameter 'formId' when calling deleteTestLead");
    }
    // verify the required parameter 'accountId' is set
    if (accountId == null) {
      throw new ApiException(400, "Missing the required parameter 'accountId' when calling deleteTestLead");
    }
    ...
    localVarQueryParameterBaseName = "accountId";
    localVarQueryParams.addAll(ApiClient.parameterToPairs("accountId", accountId));
    localVarQueryParameterBaseName = "leadId";
    localVarQueryParams.addAll(ApiClient.parameterToPairs("leadId", leadId));
   ...
   * @param accountId Connected Meta ads, Facebook or LinkedIn ads account ID. A Meta ads connection resolves its Page through the Facebook account linked to the same profile. (required)
