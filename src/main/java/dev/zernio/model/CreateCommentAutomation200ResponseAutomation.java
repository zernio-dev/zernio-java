...
@JsonPropertyOrder({
  ...
  CreateCommentAutomation200ResponseAutomation.JSON_PROPERTY_TRIGGER,
  ...
  CreateCommentAutomation200ResponseAutomation.JSON_PROPERTY_TEMPLATE,
  ...
  CreateCommentAutomation200ResponseAutomation.JSON_PROPERTY_DM_DELAY_SECONDS,
  CreateCommentAutomation200ResponseAutomation.JSON_PROPERTY_COMMENT_REPLY_DELAY_SECONDS,
  CreateCommentAutomation200ResponseAutomation.JSON_PROPERTY_AUDIENCE,
  CreateCommentAutomation200ResponseAutomation.JSON_PROPERTY_FOLLOW_GATE,
  CreateCommentAutomation200ResponseAutomation.JSON_PROPERTY_ALSO_MATCH_IN_DMS,
...
public class CreateCommentAutomation200ResponseAutomation {
  ...
  public CreateCommentAutomation200ResponseAutomation trigger(@javax.annotation.Nullable TriggerEnum trigger) {
  ...
  public CreateCommentAutomation200ResponseAutomation template(@javax.annotation.Nullable CommentAutomationTemplate template) {
  ...
  public CreateCommentAutomation200ResponseAutomation clickTag(@javax.annotation.Nullable String clickTag) {
  ...
  public CreateCommentAutomation200ResponseAutomation dmDelaySeconds(@javax.annotation.Nullable Integer dmDelaySeconds) {
  ...
  public CreateCommentAutomation200ResponseAutomation commentReplyDelaySeconds(@javax.annotation.Nullable Integer commentReplyDelaySeconds) {
  ...
  public CreateCommentAutomation200ResponseAutomation audience(@javax.annotation.Nullable CommentAutomationAudience audience) {
  ...
  public CreateCommentAutomation200ResponseAutomation followGate(@javax.annotation.Nullable CommentAutomationFollowGate followGate) {
  ...
  public CreateCommentAutomation200ResponseAutomation alsoMatchInDms(@javax.annotation.Nullable Boolean alsoMatchInDms) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, createCommentAutomation200ResponseAutomation.id) &&
        ...
        Objects.equals(this.trigger, createCommentAutomation200ResponseAutomation.trigger) &&
        ...
        equalsNullable(this.template, createCommentAutomation200ResponseAutomation.template) &&
        ...
        Objects.equals(this.dmDelaySeconds, createCommentAutomation200ResponseAutomation.dmDelaySeconds) &&
        Objects.equals(this.commentReplyDelaySeconds, createCommentAutomation200ResponseAutomation.commentReplyDelaySeconds) &&
        Objects.equals(this.audience, createCommentAutomation200ResponseAutomation.audience) &&
        Objects.equals(this.followGate, createCommentAutomation200ResponseAutomation.followGate) &&
        Objects.equals(this.alsoMatchInDms, createCommentAutomation200ResponseAutomation.alsoMatchInDms) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, platform, trigger, platformPostId, keywords, matchMode, excludeKeywords, typoTolerance, dmMessage, buttons, hashCodeNullable(template), commentReply, dmMessageVariations, commentReplyVariations, linkTracking, clickTag, dmDelaySeconds, commentReplyDelaySeconds, audience, followGate, alsoMatchInDms, isActive, stats, createdAt);
  }
