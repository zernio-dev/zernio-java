 ...
 */
@JsonPropertyOrder({
  ListPhoneNumbers200ResponseConnectedInner.JSON_PROPERTY_ACCOUNT_ID,
...
public class ListPhoneNumbers200ResponseConnectedInner {
  ...
  public ListPhoneNumbers200ResponseConnectedInner accountId(@javax.annotation.Nullable String accountId) {
  ...
  public ListPhoneNumbers200ResponseConnectedInner phoneNumber(@javax.annotation.Nullable String phoneNumber) {
  ...
  public ListPhoneNumbers200ResponseConnectedInner displayName(@javax.annotation.Nullable String displayName) {
  ...
  public ListPhoneNumbers200ResponseConnectedInner profileId(@javax.annotation.Nullable String profileId) {
  ...
  public ListPhoneNumbers200ResponseConnectedInner connectedAt(@javax.annotation.Nullable OffsetDateTime connectedAt) {
  ...
  public boolean equals(Object o) {
    ...
    ListPhoneNumbers200ResponseConnectedInner listPhoneNumbers200ResponseConnectedInner = (ListPhoneNumbers200ResponseConnectedInner) o;
    return Objects.equals(this.accountId, listPhoneNumbers200ResponseConnectedInner.accountId) &&
