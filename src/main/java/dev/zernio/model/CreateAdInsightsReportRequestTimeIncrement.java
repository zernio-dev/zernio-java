...
public class CreateAdInsightsReportRequestTimeIncrement extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CreateAdInsightsReportRequestTimeIncrement.class.getName());

    public static class CreateAdInsightsReportRequestTimeIncrementSerializer extends StdSerializer<CreateAdInsightsReportRequestTimeIncrement> {
        public CreateAdInsightsReportRequestTimeIncrementSerializer(Class<CreateAdInsightsReportRequestTimeIncrement> t) {
            super(t);
        }

        public CreateAdInsightsReportRequestTimeIncrementSerializer() {
            this(null);
        }

        @Override
        public void serialize(CreateAdInsightsReportRequestTimeIncrement value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class CreateAdInsightsReportRequestTimeIncrementDeserializer extends StdDeserializer<CreateAdInsightsReportRequestTimeIncrement> {
        public CreateAdInsightsReportRequestTimeIncrementDeserializer() {
            this(CreateAdInsightsReportRequestTimeIncrement.class);
        }

        public CreateAdInsightsReportRequestTimeIncrementDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public CreateAdInsightsReportRequestTimeIncrement deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                CreateAdInsightsReportRequestTimeIncrement ret = new CreateAdInsightsReportRequestTimeIncrement();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for CreateAdInsightsReportRequestTimeIncrement: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public CreateAdInsightsReportRequestTimeIncrement getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "CreateAdInsightsReportRequestTimeIncrement cannot be null");
        }
    }
    ...
    public CreateAdInsightsReportRequestTimeIncrement() {
        super("oneOf", Boolean.FALSE);
    }

    public CreateAdInsightsReportRequestTimeIncrement(Integer o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateAdInsightsReportRequestTimeIncrement(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(CreateAdInsightsReportRequestTimeIncrement.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return CreateAdInsightsReportRequestTimeIncrement.schemas;
    }
