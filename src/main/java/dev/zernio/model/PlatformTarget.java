...
@JsonPropertyOrder({
  ...
  PlatformTarget.JSON_PROPERTY_PLATFORM_ERROR
})
...
public class PlatformTarget {
  ...
  public enum ErrorCategoryEnum {
    ...
    PLATFORM_RATE_LIMIT(String.valueOf("platform_rate_limit")),
    
    QUOTA_EXHAUSTED(String.valueOf("quota_exhausted")),
  ...
  public PlatformTarget platformError(@javax.annotation.Nullable PostPlatformError platformError) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.platform, platformTarget.platform) &&
        ...
        Objects.equals(this.platformError, platformTarget.platformError);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(platform, accountId, customContent, customMedia, scheduledFor, platformSpecificData, status, platformPostId, hashCodeNullable(platformPostUrl), publishedAt, hashCodeNullable(removedFromPlatformAt), isTrialReel, trialGraduationStrategy, errorMessage, errorCategory, errorSource, platformError);
  }
