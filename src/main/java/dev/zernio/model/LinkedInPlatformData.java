...
@JsonPropertyOrder({
  ...
  LinkedInPlatformData.JSON_PROPERTY_AUDIENCE,
...
public class LinkedInPlatformData {
  ...
  @javax.annotation.Nullable
  private LinkedInPlatformDataAudience audience;
  ...
  public LinkedInPlatformData audience(@javax.annotation.Nullable LinkedInPlatformDataAudience audience) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public LinkedInPlatformDataAudience getAudience() {
    return audience;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_AUDIENCE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAudience(@javax.annotation.Nullable LinkedInPlatformDataAudience audience) {
    this.audience = audience;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.documentTitle, linkedInPlatformData.documentTitle) &&
        ...
        Objects.equals(this.audience, linkedInPlatformData.audience) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(documentTitle, organizationUrn, firstComment, disableLinkPreview, audience, reshareUrl, geoRestriction, poll);
  }
