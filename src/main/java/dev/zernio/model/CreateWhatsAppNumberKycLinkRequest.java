 ...
 */
@JsonPropertyOrder({
  CreateWhatsAppNumberKycLinkRequest.JSON_PROPERTY_PROFILE_ID,
  CreateWhatsAppNumberKycLinkRequest.JSON_PROPERTY_COUNTRY,
  CreateWhatsAppNumberKycLinkRequest.JSON_PROPERTY_BRANDING,
  CreateWhatsAppNumberKycLinkRequest.JSON_PROPERTY_REDIRECT_URL
})
...
public class CreateWhatsAppNumberKycLinkRequest {
  ...
  private CreateWhatsAppNumberKycLinkRequestBranding branding;

  public static final String JSON_PROPERTY_REDIRECT_URL = "redirect_url";
  @javax.annotation.Nullable
  private URI redirectUrl;

  public CreateWhatsAppNumberKycLinkRequest() { 
  }

  public CreateWhatsAppNumberKycLinkRequest profileId(@javax.annotation.Nonnull String profileId) {
  ...
  public CreateWhatsAppNumberKycLinkRequest country(@javax.annotation.Nonnull String country) {
  ...
  public CreateWhatsAppNumberKycLinkRequest branding(@javax.annotation.Nullable CreateWhatsAppNumberKycLinkRequestBranding branding) {
  ...
  public CreateWhatsAppNumberKycLinkRequestBranding getBranding() {
    return branding;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_BRANDING, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBranding(@javax.annotation.Nullable CreateWhatsAppNumberKycLinkRequestBranding branding) {
    this.branding = branding;
  }


  public CreateWhatsAppNumberKycLinkRequest redirectUrl(@javax.annotation.Nullable URI redirectUrl) {
  ...
  /**
   * Return true if this createWhatsAppNumberKycLink_request object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CreateWhatsAppNumberKycLinkRequest createWhatsAppNumberKycLinkRequest = (CreateWhatsAppNumberKycLinkRequest) o;
    return Objects.equals(this.profileId, createWhatsAppNumberKycLinkRequest.profileId) &&
        Objects.equals(this.country, createWhatsAppNumberKycLinkRequest.country) &&
        Objects.equals(this.branding, createWhatsAppNumberKycLinkRequest.branding) &&
        Objects.equals(this.redirectUrl, createWhatsAppNumberKycLinkRequest.redirectUrl);
  }
