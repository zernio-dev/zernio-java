...
public class ValidatePostRequestPlatformsInner {
  ...
  public ValidatePostRequestPlatformsInner customMedia(@javax.annotation.Nullable List<MediaItem> customMedia) {
    this.customMedia = customMedia;
    return this;
  }

  public ValidatePostRequestPlatformsInner addCustomMediaItem(MediaItem customMediaItem) {
