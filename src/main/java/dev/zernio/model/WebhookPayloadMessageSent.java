...
public class WebhookPayloadMessageSent {
  ...
  public WebhookPayloadMessageSent conversation(@javax.annotation.Nonnull InboxWebhookConversation conversation) {
  ...
  public WebhookPayloadMessageSent account(@javax.annotation.Nonnull InboxWebhookAccount account) {
