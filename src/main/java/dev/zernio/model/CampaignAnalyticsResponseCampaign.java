 ...
 */
@JsonPropertyOrder({
  CampaignAnalyticsResponseCampaign.JSON_PROPERTY_ID,
...
public class CampaignAnalyticsResponseCampaign {
  ...
  public CampaignAnalyticsResponseCampaign() { 
  }

  public CampaignAnalyticsResponseCampaign id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public CampaignAnalyticsResponseCampaign name(@javax.annotation.Nullable String name) {
  ...
  public CampaignAnalyticsResponseCampaign platform(@javax.annotation.Nullable String platform) {
  ...
  public CampaignAnalyticsResponseCampaign status(@javax.annotation.Nullable String status) {
  ...
  /**
   * Return true if this CampaignAnalyticsResponse_campaign object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CampaignAnalyticsResponseCampaign campaignAnalyticsResponseCampaign = (CampaignAnalyticsResponseCampaign) o;
    return Objects.equals(this.id, campaignAnalyticsResponseCampaign.id) &&
