...
@JsonPropertyOrder({
  ...
  CreateWebhookSettingsRequest.JSON_PROPERTY_ACCOUNT_IDS
})
...
public class CreateWebhookSettingsRequest {
  ...
  public CreateWebhookSettingsRequest accountIds(@javax.annotation.Nullable List<String> accountIds) {
    this.accountIds = accountIds;
    return this;
  }

  public CreateWebhookSettingsRequest addAccountIdsItem(String accountIdsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createWebhookSettingsRequest.name) &&
        ...
        Objects.equals(this.accountIds, createWebhookSettingsRequest.accountIds);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, url, secret, events, isActive, customHeaders, disabledResourceGroups, profileIds, accountIds);
  }
