...
@JsonDeserialize(using = UpdateProductRequestVariantsInnerCompareAtPrice.UpdateProductRequestVariantsInnerCompareAtPriceDeserializer.class)
@JsonSerialize(using = UpdateProductRequestVariantsInnerCompareAtPrice.UpdateProductRequestVariantsInnerCompareAtPriceSerializer.class)
public class UpdateProductRequestVariantsInnerCompareAtPrice extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UpdateProductRequestVariantsInnerCompareAtPrice.class.getName());

    public static class UpdateProductRequestVariantsInnerCompareAtPriceSerializer extends StdSerializer<UpdateProductRequestVariantsInnerCompareAtPrice> {
        public UpdateProductRequestVariantsInnerCompareAtPriceSerializer(Class<UpdateProductRequestVariantsInnerCompareAtPrice> t) {
            super(t);
        }

        public UpdateProductRequestVariantsInnerCompareAtPriceSerializer() {
            this(null);
        }

        @Override
        public void serialize(UpdateProductRequestVariantsInnerCompareAtPrice value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class UpdateProductRequestVariantsInnerCompareAtPriceDeserializer extends StdDeserializer<UpdateProductRequestVariantsInnerCompareAtPrice> {
        public UpdateProductRequestVariantsInnerCompareAtPriceDeserializer() {
            this(UpdateProductRequestVariantsInnerCompareAtPrice.class);
        }

        public UpdateProductRequestVariantsInnerCompareAtPriceDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public UpdateProductRequestVariantsInnerCompareAtPrice deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                UpdateProductRequestVariantsInnerCompareAtPrice ret = new UpdateProductRequestVariantsInnerCompareAtPrice();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for UpdateProductRequestVariantsInnerCompareAtPrice: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public UpdateProductRequestVariantsInnerCompareAtPrice getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            return null;
        }
    }
    ...
    public UpdateProductRequestVariantsInnerCompareAtPrice(BigDecimal o) {
        super("oneOf", Boolean.TRUE);
        setActualInstance(o);
    }

    public UpdateProductRequestVariantsInnerCompareAtPrice(String o) {
        super("oneOf", Boolean.TRUE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(UpdateProductRequestVariantsInnerCompareAtPrice.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return UpdateProductRequestVariantsInnerCompareAtPrice.schemas;
    }
