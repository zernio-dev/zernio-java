...
public class SubmitWhatsAppNumberKyc200Response {
  ...
  public SubmitWhatsAppNumberKyc200Response status(@javax.annotation.Nullable StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public SubmitWhatsAppNumberKyc200Response phoneNumber(@javax.annotation.Nullable SubmitWhatsAppNumberKyc200ResponsePhoneNumber phoneNumber) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public SubmitWhatsAppNumberKyc200ResponsePhoneNumber getPhoneNumber() {
    return phoneNumber;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_PHONE_NUMBER, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPhoneNumber(@javax.annotation.Nullable SubmitWhatsAppNumberKyc200ResponsePhoneNumber phoneNumber) {
    this.phoneNumber = phoneNumber;
  }
