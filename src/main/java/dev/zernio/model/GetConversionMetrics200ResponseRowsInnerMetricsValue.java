...
public class GetConversionMetrics200ResponseRowsInnerMetricsValue extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetConversionMetrics200ResponseRowsInnerMetricsValue.class.getName());

    public static class GetConversionMetrics200ResponseRowsInnerMetricsValueSerializer extends StdSerializer<GetConversionMetrics200ResponseRowsInnerMetricsValue> {
        public GetConversionMetrics200ResponseRowsInnerMetricsValueSerializer(Class<GetConversionMetrics200ResponseRowsInnerMetricsValue> t) {
            super(t);
        }

        public GetConversionMetrics200ResponseRowsInnerMetricsValueSerializer() {
            this(null);
        }

        @Override
        public void serialize(GetConversionMetrics200ResponseRowsInnerMetricsValue value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class GetConversionMetrics200ResponseRowsInnerMetricsValueDeserializer extends StdDeserializer<GetConversionMetrics200ResponseRowsInnerMetricsValue> {
        public GetConversionMetrics200ResponseRowsInnerMetricsValueDeserializer() {
            this(GetConversionMetrics200ResponseRowsInnerMetricsValue.class);
        }

        public GetConversionMetrics200ResponseRowsInnerMetricsValueDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public GetConversionMetrics200ResponseRowsInnerMetricsValue deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                GetConversionMetrics200ResponseRowsInnerMetricsValue ret = new GetConversionMetrics200ResponseRowsInnerMetricsValue();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for GetConversionMetrics200ResponseRowsInnerMetricsValue: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public GetConversionMetrics200ResponseRowsInnerMetricsValue getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "GetConversionMetrics200ResponseRowsInnerMetricsValue cannot be null");
        }
    }
    ...
    public GetConversionMetrics200ResponseRowsInnerMetricsValue() {
        super("oneOf", Boolean.FALSE);
    }

    public GetConversionMetrics200ResponseRowsInnerMetricsValue(BigDecimal o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public GetConversionMetrics200ResponseRowsInnerMetricsValue(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(GetConversionMetrics200ResponseRowsInnerMetricsValue.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return GetConversionMetrics200ResponseRowsInnerMetricsValue.schemas;
    }
