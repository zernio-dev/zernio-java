...
@JsonPropertyOrder({
  ...
  ListInboxReviews200ResponseDataInner.JSON_PROPERTY_RECOMMENDATION_TYPE,
...
public class ListInboxReviews200ResponseDataInner {
  ...
  private JsonNullable<RecommendationTypeEnum> recommendationType = JsonNullable.<RecommendationTypeEnum>undefined();
  ...
  public ListInboxReviews200ResponseDataInner recommendationType(@javax.annotation.Nullable RecommendationTypeEnum recommendationType) {
    this.recommendationType = JsonNullable.<RecommendationTypeEnum>of(recommendationType);
    return this;
  }
  ...
  public RecommendationTypeEnum getRecommendationType() {
        return recommendationType.orElse(null);
  }

  @JsonProperty(value = JSON_PROPERTY_RECOMMENDATION_TYPE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<RecommendationTypeEnum> getRecommendationType_JsonNullable() {
    return recommendationType;
  }
  
  @JsonProperty(JSON_PROPERTY_RECOMMENDATION_TYPE)
  public void setRecommendationType_JsonNullable(JsonNullable<RecommendationTypeEnum> recommendationType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, listInboxReviews200ResponseDataInner.id) &&
        ...
        equalsNullable(this.recommendationType, listInboxReviews200ResponseDataInner.recommendationType) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, platform, accountId, accountUsername, locationId, hashCodeNullable(locationName), reviewer, rating, hashCodeNullable(recommendationType), text, created, hasReply, hasPhotos, photoCount, photos, reply, hashCodeNullable(reviewUrl));
  }
