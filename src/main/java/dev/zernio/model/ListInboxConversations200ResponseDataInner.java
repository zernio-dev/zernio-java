...
@JsonPropertyOrder({
  ...
  ListInboxConversations200ResponseDataInner.JSON_PROPERTY_IS_GROUP,
...
public class ListInboxConversations200ResponseDataInner {
  ...
  public ListInboxConversations200ResponseDataInner isGroup(@javax.annotation.Nullable Boolean isGroup) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_IS_GROUP, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, listInboxConversations200ResponseDataInner.id) &&
        ...
        Objects.equals(this.isGroup, listInboxConversations200ResponseDataInner.isGroup) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, platform, accountId, accountUsername, participantId, participantName, hashCodeNullable(participantPicture), hashCodeNullable(participantVerifiedType), lastMessage, updatedTime, status, hashCodeNullable(unreadCount), threadControl, isGroup, hashCodeNullable(url), instagramProfile, metadata);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `isGroup` to the URL query string
    if (getIsGroup() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sisGroup%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIsGroup()))));
    }
