...
@JsonDeserialize(using = CreateMessagingAd201Response.CreateMessagingAd201ResponseDeserializer.class)
@JsonSerialize(using = CreateMessagingAd201Response.CreateMessagingAd201ResponseSerializer.class)
public class CreateMessagingAd201Response extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CreateMessagingAd201Response.class.getName());

    public static class CreateMessagingAd201ResponseSerializer extends StdSerializer<CreateMessagingAd201Response> {
        public CreateMessagingAd201ResponseSerializer(Class<CreateMessagingAd201Response> t) {
            super(t);
        }

        public CreateMessagingAd201ResponseSerializer() {
            this(null);
        }

        @Override
        public void serialize(CreateMessagingAd201Response value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class CreateMessagingAd201ResponseDeserializer extends StdDeserializer<CreateMessagingAd201Response> {
        public CreateMessagingAd201ResponseDeserializer() {
            this(CreateMessagingAd201Response.class);
        }

        public CreateMessagingAd201ResponseDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public CreateMessagingAd201Response deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                CreateMessagingAd201Response ret = new CreateMessagingAd201Response();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for CreateMessagingAd201Response: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public CreateMessagingAd201Response getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "CreateMessagingAd201Response cannot be null");
        }
    }
    ...
    public CreateMessagingAd201Response() {
        super("oneOf", Boolean.FALSE);
    }

    public CreateMessagingAd201Response(CtwaMultiResponse o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CreateMessagingAd201Response(CtwaSingleResponse o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(CreateMessagingAd201Response.class, Collections.unmodifiableMap(schemas));
        // Initialize and register the discriminator mappings.
        Map<String, Class<?>> mappings = new HashMap<String, Class<?>>();
        mappings.put("multi", CtwaMultiResponse.class);
        mappings.put("single", CtwaSingleResponse.class);
        mappings.put("createMessagingAd_201_response", CreateMessagingAd201Response.class);
        JSON.registerDiscriminator(CreateMessagingAd201Response.class, "adType", mappings);
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return CreateMessagingAd201Response.schemas;
    }
