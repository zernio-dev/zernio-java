...
public class PurchasePhoneNumber202Response {
  ...
  public PurchasePhoneNumber202Response() { 
  }

  public PurchasePhoneNumber202Response status(@javax.annotation.Nullable StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public PurchasePhoneNumber202Response country(@javax.annotation.Nullable String country) {
  ...
  /**
   * Return true if this purchasePhoneNumber_202_response object is equal to o.
   */
  @Override
