 ...
 */
@JsonPropertyOrder({
  EditInboxCommentRequest.JSON_PROPERTY_ACCOUNT_ID,
...
public class EditInboxCommentRequest {
  ...
  public EditInboxCommentRequest() { 
  }

  public EditInboxCommentRequest accountId(@javax.annotation.Nonnull String accountId) {
  ...
  public EditInboxCommentRequest platform(@javax.annotation.Nonnull PlatformEnum platform) {
  ...
  public EditInboxCommentRequest content(@javax.annotation.Nonnull String content) {
  ...
  /**
   * Return true if this editInboxComment_request object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    EditInboxCommentRequest editInboxCommentRequest = (EditInboxCommentRequest) o;
    return Objects.equals(this.accountId, editInboxCommentRequest.accountId) &&
        Objects.equals(this.platform, editInboxCommentRequest.platform) &&
        Objects.equals(this.content, editInboxCommentRequest.content);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, platform, content);
  }
