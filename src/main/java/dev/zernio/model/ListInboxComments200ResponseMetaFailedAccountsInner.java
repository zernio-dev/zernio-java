 ...
 */
@JsonPropertyOrder({
  ListInboxComments200ResponseMetaFailedAccountsInner.JSON_PROPERTY_ACCOUNT_ID,
  ListInboxComments200ResponseMetaFailedAccountsInner.JSON_PROPERTY_ACCOUNT_USERNAME,
  ListInboxComments200ResponseMetaFailedAccountsInner.JSON_PROPERTY_PLATFORM,
  ListInboxComments200ResponseMetaFailedAccountsInner.JSON_PROPERTY_ERROR,
  ListInboxComments200ResponseMetaFailedAccountsInner.JSON_PROPERTY_CODE,
  ListInboxComments200ResponseMetaFailedAccountsInner.JSON_PROPERTY_RETRY_AFTER
})
...
public class ListInboxComments200ResponseMetaFailedAccountsInner {
  ...
  public ListInboxComments200ResponseMetaFailedAccountsInner() { 
  }

  public ListInboxComments200ResponseMetaFailedAccountsInner accountId(@javax.annotation.Nullable String accountId) {
  ...
  public ListInboxComments200ResponseMetaFailedAccountsInner accountUsername(@javax.annotation.Nullable String accountUsername) {
  ...
  public ListInboxComments200ResponseMetaFailedAccountsInner platform(@javax.annotation.Nullable String platform) {
  ...
  public ListInboxComments200ResponseMetaFailedAccountsInner error(@javax.annotation.Nullable String error) {
    this.error = error;
    return this;
  }
  ...
  public ListInboxComments200ResponseMetaFailedAccountsInner code(@javax.annotation.Nullable String code) {
  ...
  public ListInboxComments200ResponseMetaFailedAccountsInner retryAfter(@javax.annotation.Nullable Integer retryAfter) {
  ...
  /**
   * Return true if this listInboxComments_200_response_meta_failedAccounts_inner object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ListInboxComments200ResponseMetaFailedAccountsInner listInboxComments200ResponseMetaFailedAccountsInner = (ListInboxComments200ResponseMetaFailedAccountsInner) o;
    return Objects.equals(this.accountId, listInboxComments200ResponseMetaFailedAccountsInner.accountId) &&
        equalsNullable(this.accountUsername, listInboxComments200ResponseMetaFailedAccountsInner.accountUsername) &&
        Objects.equals(this.platform, listInboxComments200ResponseMetaFailedAccountsInner.platform) &&
        Objects.equals(this.error, listInboxComments200ResponseMetaFailedAccountsInner.error) &&
        equalsNullable(this.code, listInboxComments200ResponseMetaFailedAccountsInner.code) &&
        equalsNullable(this.retryAfter, listInboxComments200ResponseMetaFailedAccountsInner.retryAfter);
  }
