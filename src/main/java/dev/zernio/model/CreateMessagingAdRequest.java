...
@JsonPropertyOrder({
  ...
  CreateMessagingAdRequest.JSON_PROPERTY_TRACKING,
  ...
  CreateMessagingAdRequest.JSON_PROPERTY_CAMPAIGN_NAME,
  CreateMessagingAdRequest.JSON_PROPERTY_AD_SET_NAME,
  CreateMessagingAdRequest.JSON_PROPERTY_PLATFORM_POST_ID,
  CreateMessagingAdRequest.JSON_PROPERTY_EXISTING_POST_ID,
  CreateMessagingAdRequest.JSON_PROPERTY_OBJECT_STORY_ID,
  CreateMessagingAdRequest.JSON_PROPERTY_PAGE_ID,
  CreateMessagingAdRequest.JSON_PROPERTY_WHATSAPP_PHONE_NUMBER,
  CreateMessagingAdRequest.JSON_PROPERTY_HEADLINE,
  CreateMessagingAdRequest.JSON_PROPERTY_BODY,
  CreateMessagingAdRequest.JSON_PROPERTY_IMAGE_URL,
  CreateMessagingAdRequest.JSON_PROPERTY_VIDEO,
  CreateMessagingAdRequest.JSON_PROPERTY_WELCOME_MESSAGE,
  ...
  CreateMessagingAdRequest.JSON_PROPERTY_END_DATE,
  CreateMessagingAdRequest.JSON_PROPERTY_COUNTRIES,
  CreateMessagingAdRequest.JSON_PROPERTY_CITIES,
  CreateMessagingAdRequest.JSON_PROPERTY_REGIONS,
  CreateMessagingAdRequest.JSON_PROPERTY_ZIPS,
  CreateMessagingAdRequest.JSON_PROPERTY_METROS,
  CreateMessagingAdRequest.JSON_PROPERTY_COUNTRY_GROUPS,
  CreateMessagingAdRequest.JSON_PROPERTY_CUSTOM_LOCATIONS,
  CreateMessagingAdRequest.JSON_PROPERTY_AGE_MIN,
  CreateMessagingAdRequest.JSON_PROPERTY_AGE_MAX,
  CreateMessagingAdRequest.JSON_PROPERTY_INTERESTS,
  CreateMessagingAdRequest.JSON_PROPERTY_AUDIENCE_ID,
  CreateMessagingAdRequest.JSON_PROPERTY_PLACEMENTS,
  CreateMessagingAdRequest.JSON_PROPERTY_ADVANTAGE_AUDIENCE,
  CreateMessagingAdRequest.JSON_PROPERTY_OBJECTIVE,
  CreateMessagingAdRequest.JSON_PROPERTY_STATUS,
  CreateMessagingAdRequest.JSON_PROPERTY_CAMPAIGN_STATUS,
  CreateMessagingAdRequest.JSON_PROPERTY_BID_STRATEGY,
  CreateMessagingAdRequest.JSON_PROPERTY_BID_AMOUNT,
  CreateMessagingAdRequest.JSON_PROPERTY_ROAS_AVERAGE_FLOOR,
  ...
  CreateMessagingAdRequest.JSON_PROPERTY_DESTINATIONS
})
...
public class CreateMessagingAdRequest {
  ...
  public CreateMessagingAdRequest tracking(@javax.annotation.Nullable AdTracking tracking) {
  ...
  public CreateMessagingAdRequest adAccountId(@javax.annotation.Nonnull String adAccountId) {
  ...
  public CreateMessagingAdRequest name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateMessagingAdRequest campaignName(@javax.annotation.Nullable String campaignName) {
  ...
  public CreateMessagingAdRequest adSetName(@javax.annotation.Nullable String adSetName) {
  ...
  public CreateMessagingAdRequest platformPostId(@javax.annotation.Nullable String platformPostId) {
  ...
  public CreateMessagingAdRequest existingPostId(@javax.annotation.Nullable String existingPostId) {
  ...
  public CreateMessagingAdRequest objectStoryId(@javax.annotation.Nullable String objectStoryId) {
  ...
  public CreateMessagingAdRequest pageId(@javax.annotation.Nullable String pageId) {
    this.pageId = pageId;
    return this;
  }
  ...
  public CreateMessagingAdRequest whatsappPhoneNumber(@javax.annotation.Nullable String whatsappPhoneNumber) {
  ...
  public CreateMessagingAdRequest headline(@javax.annotation.Nullable String headline) {
  ...
  public CreateMessagingAdRequest body(@javax.annotation.Nullable String body) {
    this.body = body;
    return this;
  }
  ...
  public CreateMessagingAdRequest imageUrl(@javax.annotation.Nullable URI imageUrl) {
  ...
  public CreateMessagingAdRequest video(@javax.annotation.Nullable CtwaAdRequestBodyVideo video) {
    this.video = video;
    return this;
  }
  ...
  public CreateMessagingAdRequest welcomeMessage(@javax.annotation.Nullable CtwaAdRequestBodyWelcomeMessage welcomeMessage) {
  ...
  public CreateMessagingAdRequest creatives(@javax.annotation.Nullable List<CtwaAdRequestBodyCreativesInner> creatives) {
    this.creatives = creatives;
    return this;
  }

  public CreateMessagingAdRequest addCreativesItem(CtwaAdRequestBodyCreativesInner creativesItem) {
  ...
  public CreateMessagingAdRequest currency(@javax.annotation.Nullable String currency) {
  ...
  public CreateMessagingAdRequest endDate(@javax.annotation.Nullable OffsetDateTime endDate) {
  ...
  public CreateMessagingAdRequest countries(@javax.annotation.Nullable List<String> countries) {
    this.countries = countries;
    return this;
  }

  public CreateMessagingAdRequest addCountriesItem(String countriesItem) {
  ...
  public CreateMessagingAdRequest cities(@javax.annotation.Nullable List<CtwaAdRequestBodyCitiesInner> cities) {
    this.cities = cities;
    return this;
  }

  public CreateMessagingAdRequest addCitiesItem(CtwaAdRequestBodyCitiesInner citiesItem) {
    if (this.cities == null) {
  ...
  public CreateMessagingAdRequest regions(@javax.annotation.Nullable List<CtwaAdRequestBodyRegionsInner> regions) {
    this.regions = regions;
    return this;
  }

  public CreateMessagingAdRequest addRegionsItem(CtwaAdRequestBodyRegionsInner regionsItem) {
  ...
  public CreateMessagingAdRequest zips(@javax.annotation.Nullable List<CtwaAdRequestBodyZipsInner> zips) {
    this.zips = zips;
    return this;
  }

  public CreateMessagingAdRequest addZipsItem(CtwaAdRequestBodyZipsInner zipsItem) {
    if (this.zips == null) {
  ...
  public CreateMessagingAdRequest metros(@javax.annotation.Nullable List<CtwaAdRequestBodyZipsInner> metros) {
    this.metros = metros;
    return this;
  }

  public CreateMessagingAdRequest addMetrosItem(CtwaAdRequestBodyZipsInner metrosItem) {
    if (this.metros == null) {
  ...
  public CreateMessagingAdRequest countryGroups(@javax.annotation.Nullable List<CountryGroupsEnum> countryGroups) {
    this.countryGroups = countryGroups;
    return this;
  }

  public CreateMessagingAdRequest addCountryGroupsItem(CountryGroupsEnum countryGroupsItem) {
  ...
  public CreateMessagingAdRequest customLocations(@javax.annotation.Nullable List<CreateStandaloneAdRequestCustomLocationsInner> customLocations) {
    this.customLocations = customLocations;
    return this;
  }

  public CreateMessagingAdRequest addCustomLocationsItem(CreateStandaloneAdRequestCustomLocationsInner customLocationsItem) {
  ...
  public CreateMessagingAdRequest ageMin(@javax.annotation.Nullable Integer ageMin) {
    this.ageMin = ageMin;
    return this;
  }
  ...
  public CreateMessagingAdRequest ageMax(@javax.annotation.Nullable Integer ageMax) {
    this.ageMax = ageMax;
    return this;
  }
  ...
  public CreateMessagingAdRequest interests(@javax.annotation.Nullable List<CreateStandaloneAdRequestBehaviorsInner> interests) {
    this.interests = interests;
    return this;
  }

  public CreateMessagingAdRequest addInterestsItem(CreateStandaloneAdRequestBehaviorsInner interestsItem) {
  ...
  public CreateMessagingAdRequest audienceId(@javax.annotation.Nullable String audienceId) {
  ...
  public CreateMessagingAdRequest placements(@javax.annotation.Nullable CtwaAdRequestBodyPlacements placements) {
  ...
  public CreateMessagingAdRequest advantageAudience(@javax.annotation.Nullable AdvantageAudienceEnum advantageAudience) {
  ...
  public CreateMessagingAdRequest objective(@javax.annotation.Nullable ObjectiveEnum objective) {
  ...
  public CreateMessagingAdRequest status(@javax.annotation.Nullable StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public CreateMessagingAdRequest campaignStatus(@javax.annotation.Nullable CampaignStatusEnum campaignStatus) {
  ...
  public CreateMessagingAdRequest bidStrategy(@javax.annotation.Nullable BidStrategyEnum bidStrategy) {
  ...
  public CreateMessagingAdRequest bidAmount(@javax.annotation.Nullable BigDecimal bidAmount) {
  ...
  public CreateMessagingAdRequest roasAverageFloor(@javax.annotation.Nullable BigDecimal roasAverageFloor) {
  ...
  public CreateMessagingAdRequest dsaBeneficiary(@javax.annotation.Nullable String dsaBeneficiary) {
  ...
  public CreateMessagingAdRequest dsaPayor(@javax.annotation.Nullable String dsaPayor) {
  ...
  public CreateMessagingAdRequest regionalRegulatedCategories(@javax.annotation.Nullable List<String> regionalRegulatedCategories) {
    this.regionalRegulatedCategories = regionalRegulatedCategories;
    return this;
  }

  public CreateMessagingAdRequest addRegionalRegulatedCategoriesItem(String regionalRegulatedCategoriesItem) {
  ...
  public CreateMessagingAdRequest destination(@javax.annotation.Nullable DestinationEnum destination) {
  ...
  public CreateMessagingAdRequest destinations(@javax.annotation.Nullable List<DestinationsEnum> destinations) {
    this.destinations = destinations;
    return this;
  }

  public CreateMessagingAdRequest addDestinationsItem(DestinationsEnum destinationsItem) {
  ...
  @JsonProperty(value = JSON_PROPERTY_DESTINATIONS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDestinations(@javax.annotation.Nullable List<DestinationsEnum> destinations) {
    this.destinations = destinations;
  }


  /**
   * Return true if this createMessagingAd_request object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.creativeFeatures, createMessagingAdRequest.creativeFeatures) &&
        Objects.equals(this.tracking, createMessagingAdRequest.tracking) &&
        ...
        Objects.equals(this.campaignName, createMessagingAdRequest.campaignName) &&
        Objects.equals(this.adSetName, createMessagingAdRequest.adSetName) &&
        Objects.equals(this.platformPostId, createMessagingAdRequest.platformPostId) &&
        Objects.equals(this.existingPostId, createMessagingAdRequest.existingPostId) &&
        Objects.equals(this.objectStoryId, createMessagingAdRequest.objectStoryId) &&
        Objects.equals(this.pageId, createMessagingAdRequest.pageId) &&
        Objects.equals(this.whatsappPhoneNumber, createMessagingAdRequest.whatsappPhoneNumber) &&
        Objects.equals(this.headline, createMessagingAdRequest.headline) &&
        Objects.equals(this.body, createMessagingAdRequest.body) &&
        Objects.equals(this.imageUrl, createMessagingAdRequest.imageUrl) &&
        Objects.equals(this.video, createMessagingAdRequest.video) &&
        Objects.equals(this.welcomeMessage, createMessagingAdRequest.welcomeMessage) &&
        ...
        Objects.equals(this.endDate, createMessagingAdRequest.endDate) &&
        Objects.equals(this.countries, createMessagingAdRequest.countries) &&
        Objects.equals(this.cities, createMessagingAdRequest.cities) &&
        Objects.equals(this.regions, createMessagingAdRequest.regions) &&
        Objects.equals(this.zips, createMessagingAdRequest.zips) &&
        Objects.equals(this.metros, createMessagingAdRequest.metros) &&
        Objects.equals(this.countryGroups, createMessagingAdRequest.countryGroups) &&
        Objects.equals(this.customLocations, createMessagingAdRequest.customLocations) &&
        Objects.equals(this.ageMin, createMessagingAdRequest.ageMin) &&
        Objects.equals(this.ageMax, createMessagingAdRequest.ageMax) &&
        Objects.equals(this.interests, createMessagingAdRequest.interests) &&
        Objects.equals(this.audienceId, createMessagingAdRequest.audienceId) &&
        Objects.equals(this.placements, createMessagingAdRequest.placements) &&
        Objects.equals(this.advantageAudience, createMessagingAdRequest.advantageAudience) &&
        Objects.equals(this.objective, createMessagingAdRequest.objective) &&
        Objects.equals(this.status, createMessagingAdRequest.status) &&
        Objects.equals(this.campaignStatus, createMessagingAdRequest.campaignStatus) &&
        Objects.equals(this.bidStrategy, createMessagingAdRequest.bidStrategy) &&
        Objects.equals(this.bidAmount, createMessagingAdRequest.bidAmount) &&
        Objects.equals(this.roasAverageFloor, createMessagingAdRequest.roasAverageFloor) &&
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getDestinations() != null) {
      for (int i = 0; i < getDestinations().size(); i++) {
        joiner.add(String.format(java.util.Locale.ROOT, "%sdestinations%s%s=%s", prefix, suffix,
            "".equals(suffix) ? "" : String.format(java.util.Locale.ROOT, "%s%d%s", containerPrefix, i, containerSuffix),
            ApiClient.urlEncode(ApiClient.valueToString(getDestinations().get(i)))));
      }
    }
