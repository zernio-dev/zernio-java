 ...
 */
@JsonPropertyOrder({
  UpdatePostRequestPlatformsInner.JSON_PROPERTY_PLATFORM,
  UpdatePostRequestPlatformsInner.JSON_PROPERTY_ACCOUNT_ID,
  UpdatePostRequestPlatformsInner.JSON_PROPERTY_CUSTOM_CONTENT,
  UpdatePostRequestPlatformsInner.JSON_PROPERTY_CUSTOM_MEDIA,
...
public class UpdatePostRequestPlatformsInner {
  ...
  public UpdatePostRequestPlatformsInner() { 
  }

  public UpdatePostRequestPlatformsInner platform(@javax.annotation.Nonnull String platform) {
  ...
  public UpdatePostRequestPlatformsInner accountId(@javax.annotation.Nonnull String accountId) {
  ...
  public UpdatePostRequestPlatformsInner customContent(@javax.annotation.Nullable String customContent) {
  ...
  public UpdatePostRequestPlatformsInner customMedia(@javax.annotation.Nullable List<MediaItem> customMedia) {
    this.customMedia = customMedia;
    return this;
  }

  public UpdatePostRequestPlatformsInner addCustomMediaItem(MediaItem customMediaItem) {
  ...
  public UpdatePostRequestPlatformsInner scheduledFor(@javax.annotation.Nullable OffsetDateTime scheduledFor) {
  ...
  public UpdatePostRequestPlatformsInner platformSpecificData(@javax.annotation.Nullable Map<String, Object> platformSpecificData) {
    this.platformSpecificData = platformSpecificData;
    return this;
  }

  public UpdatePostRequestPlatformsInner putPlatformSpecificDataItem(String key, Object platformSpecificDataItem) {
  ...
  /**
   * Return true if this updatePost_request_platforms_inner object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    UpdatePostRequestPlatformsInner updatePostRequestPlatformsInner = (UpdatePostRequestPlatformsInner) o;
    return Objects.equals(this.platform, updatePostRequestPlatformsInner.platform) &&
        Objects.equals(this.accountId, updatePostRequestPlatformsInner.accountId) &&
        Objects.equals(this.customContent, updatePostRequestPlatformsInner.customContent) &&
        Objects.equals(this.customMedia, updatePostRequestPlatformsInner.customMedia) &&
        Objects.equals(this.scheduledFor, updatePostRequestPlatformsInner.scheduledFor) &&
        Objects.equals(this.platformSpecificData, updatePostRequestPlatformsInner.platformSpecificData);
  }
