 ...
 */
@JsonPropertyOrder({
  PurchasePhoneNumber200ResponseOneOf1PhoneNumber.JSON_PROPERTY_ID,
  PurchasePhoneNumber200ResponseOneOf1PhoneNumber.JSON_PROPERTY_PHONE_NUMBER,
  PurchasePhoneNumber200ResponseOneOf1PhoneNumber.JSON_PROPERTY_STATUS,
...
public class PurchasePhoneNumber200ResponseOneOf1PhoneNumber {
  ...
  public PurchasePhoneNumber200ResponseOneOf1PhoneNumber id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public PurchasePhoneNumber200ResponseOneOf1PhoneNumber phoneNumber(@javax.annotation.Nullable String phoneNumber) {
  ...
  public PurchasePhoneNumber200ResponseOneOf1PhoneNumber status(@javax.annotation.Nullable String status) {
    this.status = status;
    return this;
  }
  ...
  public PurchasePhoneNumber200ResponseOneOf1PhoneNumber country(@javax.annotation.Nullable String country) {
  ...
  public PurchasePhoneNumber200ResponseOneOf1PhoneNumber provisionedAt(@javax.annotation.Nullable OffsetDateTime provisionedAt) {
  ...
  public PurchasePhoneNumber200ResponseOneOf1PhoneNumber metaPreverifiedId(@javax.annotation.Nullable String metaPreverifiedId) {
  ...
  public PurchasePhoneNumber200ResponseOneOf1PhoneNumber metaVerificationStatus(@javax.annotation.Nullable String metaVerificationStatus) {
  ...
  public boolean equals(Object o) {
    ...
    PurchasePhoneNumber200ResponseOneOf1PhoneNumber purchasePhoneNumber200ResponseOneOf1PhoneNumber = (PurchasePhoneNumber200ResponseOneOf1PhoneNumber) o;
    return Objects.equals(this.id, purchasePhoneNumber200ResponseOneOf1PhoneNumber.id) &&
        Objects.equals(this.phoneNumber, purchasePhoneNumber200ResponseOneOf1PhoneNumber.phoneNumber) &&
        Objects.equals(this.status, purchasePhoneNumber200ResponseOneOf1PhoneNumber.status) &&
