...
public class UpdateCampaignTargeting200Response {
  ...
  public enum UpdatedEnum {
    ...
    LOCATION_TARGETING_TYPE(String.valueOf("locationTargetingType"));
  ...
  public UpdateCampaignTargeting200Response locationTargetingType(@javax.annotation.Nullable LocationTargetingTypeEnum locationTargetingType) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(campaignId, updated, hashCodeNullable(locationTargetingType), devices, locations, languages);
  }
