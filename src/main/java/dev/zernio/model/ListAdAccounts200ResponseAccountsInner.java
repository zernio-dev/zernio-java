...
public class ListAdAccounts200ResponseAccountsInner {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, currency, businessId, businessName, status, hashCodeNullable(accountStatus), approvalStatus, disableReason, timezoneName, timezoneOffsetHoursUtc, minimumDailyBudget, fundingSource, fundingSourceDetails, selectable, hashCodeNullable(unusableReason));
  }
