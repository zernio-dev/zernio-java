...
public class GetCampaignTargeting200Response {
  ...
  public enum LocationTargetingTypeEnum {
    ...
    PRESENCE_OR_INTEREST(String.valueOf("presence_or_interest"));

    private String value;

    LocationTargetingTypeEnum(String value) {
      this.value = value;
    }
    ...
    @JsonCreator
    public static LocationTargetingTypeEnum fromValue(String value) {
      for (LocationTargetingTypeEnum b : LocationTargetingTypeEnum.values()) {
  ...
  private JsonNullable<LocationTargetingTypeEnum> locationTargetingType = JsonNullable.<LocationTargetingTypeEnum>undefined();
  ...
  public GetCampaignTargeting200Response locationTargetingType(@javax.annotation.Nullable LocationTargetingTypeEnum locationTargetingType) {
    this.locationTargetingType = JsonNullable.<LocationTargetingTypeEnum>of(locationTargetingType);
    return this;
  }
  ...
  @javax.annotation.Nullable
  @JsonIgnore
  public LocationTargetingTypeEnum getLocationTargetingType() {
        return locationTargetingType.orElse(null);
  }

  @JsonProperty(value = JSON_PROPERTY_LOCATION_TARGETING_TYPE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<LocationTargetingTypeEnum> getLocationTargetingType_JsonNullable() {
    return locationTargetingType;
  }
  
  @JsonProperty(JSON_PROPERTY_LOCATION_TARGETING_TYPE)
  public void setLocationTargetingType_JsonNullable(JsonNullable<LocationTargetingTypeEnum> locationTargetingType) {
    this.locationTargetingType = locationTargetingType;
  }

  public void setLocationTargetingType(@javax.annotation.Nullable LocationTargetingTypeEnum locationTargetingType) {
    this.locationTargetingType = JsonNullable.<LocationTargetingTypeEnum>of(locationTargetingType);
  }
