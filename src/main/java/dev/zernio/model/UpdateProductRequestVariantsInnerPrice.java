...
@JsonDeserialize(using = UpdateProductRequestVariantsInnerPrice.UpdateProductRequestVariantsInnerPriceDeserializer.class)
@JsonSerialize(using = UpdateProductRequestVariantsInnerPrice.UpdateProductRequestVariantsInnerPriceSerializer.class)
public class UpdateProductRequestVariantsInnerPrice extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(UpdateProductRequestVariantsInnerPrice.class.getName());

    public static class UpdateProductRequestVariantsInnerPriceSerializer extends StdSerializer<UpdateProductRequestVariantsInnerPrice> {
        public UpdateProductRequestVariantsInnerPriceSerializer(Class<UpdateProductRequestVariantsInnerPrice> t) {
            super(t);
        }

        public UpdateProductRequestVariantsInnerPriceSerializer() {
            this(null);
        }

        @Override
        public void serialize(UpdateProductRequestVariantsInnerPrice value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class UpdateProductRequestVariantsInnerPriceDeserializer extends StdDeserializer<UpdateProductRequestVariantsInnerPrice> {
        public UpdateProductRequestVariantsInnerPriceDeserializer() {
            this(UpdateProductRequestVariantsInnerPrice.class);
        }

        public UpdateProductRequestVariantsInnerPriceDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public UpdateProductRequestVariantsInnerPrice deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (match == 1) {
                UpdateProductRequestVariantsInnerPrice ret = new UpdateProductRequestVariantsInnerPrice();
                ret.setActualInstance(deserialized);
                return ret;
            }
            throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for UpdateProductRequestVariantsInnerPrice: %d classes match result, expected 1", match));
        }
         ...
         */
        @Override
        public UpdateProductRequestVariantsInnerPrice getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "UpdateProductRequestVariantsInnerPrice cannot be null");
        }
    }
    ...
    public UpdateProductRequestVariantsInnerPrice() {
        super("oneOf", Boolean.FALSE);
    }

    public UpdateProductRequestVariantsInnerPrice(BigDecimal o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public UpdateProductRequestVariantsInnerPrice(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(UpdateProductRequestVariantsInnerPrice.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return UpdateProductRequestVariantsInnerPrice.schemas;
    }
