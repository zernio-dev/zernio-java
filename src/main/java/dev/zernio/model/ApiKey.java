...
import dev.zernio.model.ApiKeyCreatedBy;
...
public class ApiKey {
  ...
  public ApiKey createdBy(@javax.annotation.Nullable ApiKeyCreatedBy createdBy) {
  ...
  @JsonProperty(value = JSON_PROPERTY_CREATED_BY, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCreatedBy(@javax.annotation.Nullable ApiKeyCreatedBy createdBy) {
    this.createdBy = createdBy;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, keyPreview, expiresAt, createdAt, key, scope, profileIds, permission, disabledResourceGroups, createdBy);
  }
