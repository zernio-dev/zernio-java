...
@JsonPropertyOrder({
  ...
  GetAccountHealth200Response.JSON_PROPERTY_INTEGRATION_LANE,
...
public class GetAccountHealth200Response {
  ...
  public enum IntegrationLaneEnum {
    ...
    IntegrationLaneEnum(String value) {
      this.value = value;
    }
    ...
    @JsonCreator
    public static IntegrationLaneEnum fromValue(String value) {
      for (IntegrationLaneEnum b : IntegrationLaneEnum.values()) {
  ...
  public static final String JSON_PROPERTY_INTEGRATION_LANE = "integrationLane";
  @javax.annotation.Nullable
  private IntegrationLaneEnum integrationLane;
  ...
  public GetAccountHealth200Response integrationLane(@javax.annotation.Nullable IntegrationLaneEnum integrationLane) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_INTEGRATION_LANE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public IntegrationLaneEnum getIntegrationLane() {
    return integrationLane;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_INTEGRATION_LANE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIntegrationLane(@javax.annotation.Nullable IntegrationLaneEnum integrationLane) {
    this.integrationLane = integrationLane;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, getAccountHealth200Response.accountId) &&
        ...
        Objects.equals(this.integrationLane, getAccountHealth200Response.integrationLane) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, platform, integrationLane, username, displayName, status, tokenStatus, permissions, issues, recommendations, messagingRestriction, platformConnection);
  }
  ...
  public String toString() {
    ...
    sb.append("    integrationLane: ").append(toIndentedString(integrationLane)).append("\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `integrationLane` to the URL query string
    if (getIntegrationLane() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sintegrationLane%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIntegrationLane()))));
    }
