...
public class CtwaAdRequestBodyVideo {
  ...
  public CtwaAdRequestBodyVideo url(@javax.annotation.Nonnull URI url) {
    this.url = url;
    return this;
  }
  ...
  public CtwaAdRequestBodyVideo thumbnailUrl(@javax.annotation.Nonnull URI thumbnailUrl) {
