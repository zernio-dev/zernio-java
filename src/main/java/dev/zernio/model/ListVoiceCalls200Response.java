 ...
 */
@JsonPropertyOrder({
  ListVoiceCalls200Response.JSON_PROPERTY_CALLS,
  ListVoiceCalls200Response.JSON_PROPERTY_NEXT_CURSOR
})
...
public class ListVoiceCalls200Response {
  ...
  public ListVoiceCalls200Response() { 
  }

  public ListVoiceCalls200Response calls(@javax.annotation.Nullable List<CallRecord> calls) {
    this.calls = calls;
    return this;
  }

  public ListVoiceCalls200Response addCallsItem(CallRecord callsItem) {
    if (this.calls == null) {
  ...
  @JsonProperty(value = JSON_PROPERTY_CALLS, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCalls(@javax.annotation.Nullable List<CallRecord> calls) {
    this.calls = calls;
  }


  public ListVoiceCalls200Response nextCursor(@javax.annotation.Nullable OffsetDateTime nextCursor) {
  ...
  /**
   * Return true if this listVoiceCalls_200_response object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ListVoiceCalls200Response listVoiceCalls200Response = (ListVoiceCalls200Response) o;
    return Objects.equals(this.calls, listVoiceCalls200Response.calls) &&
        equalsNullable(this.nextCursor, listVoiceCalls200Response.nextCursor);
  }
