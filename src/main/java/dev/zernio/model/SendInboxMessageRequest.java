...
@JsonPropertyOrder({
  ...
  SendInboxMessageRequest.JSON_PROPERTY_LINK_PREVIEW,
  ...
  SendInboxMessageRequest.JSON_PROPERTY_SUBJECT,
  SendInboxMessageRequest.JSON_PROPERTY_EFFECT,
  SendInboxMessageRequest.JSON_PROPERTY_CONTACT_CARD,
  SendInboxMessageRequest.JSON_PROPERTY_CHANNEL,
...
public class SendInboxMessageRequest {
  ...
  public enum EffectEnum {
    SLAM(String.valueOf("slam")),
    
    LOUD(String.valueOf("loud")),
    
    GENTLE(String.valueOf("gentle")),
    
    INVISIBLE_INK(String.valueOf("invisibleInk")),
    
    ECHO(String.valueOf("echo")),
    
    SPOTLIGHT(String.valueOf("spotlight")),
    
    BALLOONS(String.valueOf("balloons")),
    
    CONFETTI(String.valueOf("confetti")),
    
    LOVE(String.valueOf("love")),
    
    LASERS(String.valueOf("lasers")),
    
    FIREWORKS(String.valueOf("fireworks")),
    
    SHOOTING_STAR(String.valueOf("shootingStar")),
    
    CELEBRATION(String.valueOf("celebration"));
  ...
  public static final String JSON_PROPERTY_CONTACT_CARD = "contactCard";
  @javax.annotation.Nullable
  ...
  public SendInboxMessageRequest linkPreview(@javax.annotation.Nullable Boolean linkPreview) {
  ...
  public SendInboxMessageRequest subject(@javax.annotation.Nullable String subject) {
  ...
  public SendInboxMessageRequest effect(@javax.annotation.Nullable EffectEnum effect) {
    this.effect = effect;
    return this;
  }
  ...
  public SendInboxMessageRequest contactCard(@javax.annotation.Nullable Boolean contactCard) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_CONTACT_CARD, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_CONTACT_CARD, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setContactCard(@javax.annotation.Nullable Boolean contactCard) {
    this.contactCard = contactCard;
  }


  public SendInboxMessageRequest channel(@javax.annotation.Nullable ChannelEnum channel) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, sendInboxMessageRequest.accountId) &&
        ...
        Objects.equals(this.linkPreview, sendInboxMessageRequest.linkPreview) &&
        ...
        Objects.equals(this.subject, sendInboxMessageRequest.subject) &&
        Objects.equals(this.effect, sendInboxMessageRequest.effect) &&
        Objects.equals(this.contactCard, sendInboxMessageRequest.contactCard) &&
        Objects.equals(this.channel, sendInboxMessageRequest.channel) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountId, message, attachmentUrl, category, linkPreview, attachmentType, attachmentName, voiceNote, subject, effect, contactCard, channel, quickReplies, buttons, template, interactive, replyMarkup, messagingType, messageTag, replyTo, location, contacts);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `contactCard` to the URL query string
    if (getContactCard() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%scontactCard%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getContactCard()))));
    }
