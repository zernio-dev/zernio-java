...
public class SubmitWhatsAppNumberKycRequestDocumentsInnerOneOf {
  ...
  public SubmitWhatsAppNumberKycRequestDocumentsInnerOneOf requirementId(@javax.annotation.Nonnull String requirementId) {
  ...
  /**
   * Return true if this submitWhatsAppNumberKyc_request_documents_inner_oneOf object is equal to o.
   */
  @Override
