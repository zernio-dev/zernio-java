 ...
 */
@JsonPropertyOrder({
  AdTracking.JSON_PROPERTY_PIXEL_ID,
  AdTracking.JSON_PROPERTY_URL_TAGS
})
...
public class AdTracking {
  ...
  public AdTracking pixelId(@javax.annotation.Nullable String pixelId) {
  ...
  public AdTracking urlTags(@javax.annotation.Nullable List<UpdateAdTrackingTagsRequestUrlTagsInner> urlTags) {
    this.urlTags = urlTags;
    return this;
  }

  public AdTracking addUrlTagsItem(UpdateAdTrackingTagsRequestUrlTagsInner urlTagsItem) {
  ...
  /**
   * Return true if this AdTracking object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    AdTracking adTracking = (AdTracking) o;
    return Objects.equals(this.pixelId, adTracking.pixelId) &&
        Objects.equals(this.urlTags, adTracking.urlTags);
  }
