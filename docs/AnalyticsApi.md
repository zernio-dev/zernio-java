...
| [**getFacebookPostEarningsWithHttpInfo**](AnalyticsApi.md#getFacebookPostEarningsWithHttpInfo) | **GET** /v1/analytics/facebook/post-earnings | Get Facebook post monetization earnings |
...
| [**getLinkedInOrgAggregateAnalyticsWithHttpInfo**](AnalyticsApi.md#getLinkedInOrgAggregateAnalyticsWithHttpInfo) | **GET** /v1/analytics/linkedin/org-aggregate-analytics | Get LinkedIn org analytics |
...
| [**getYouTubeChannelInsightsWithHttpInfo**](AnalyticsApi.md#getYouTubeChannelInsightsWithHttpInfo) | **GET** /v1/analytics/youtube/channel-insights | Get YouTube channel insights |
...
public class Example {
    public static void main(String[] args) {
        ...
        String sortBy = "date"; // String | Sort by date, engagement, or a specific metric. Instagram-only metrics (follows, reposts, reels_skip_rate, ig_reels_*) sort posts with no value as 0.
...
> FacebookPostEarningsResponse getFacebookPostEarnings(accountId, postId, metrics)
...
## getFacebookPostEarningsWithHttpInfo

> ApiResponse<FacebookPostEarningsResponse> getFacebookPostEarnings getFacebookPostEarningsWithHttpInfo(accountId, postId, metrics)
...
ApiResponse<[**FacebookPostEarningsResponse**](FacebookPostEarningsResponse.md)>
...
> GetFacebookPostReactions200Response getFacebookPostReactions(accountId, postId)
...
public class Example {
    public static void main(String[] args) {
        ...
        AnalyticsApi apiInstance = new AnalyticsApi(defaultClient);
        String accountId = "accountId_example"; // String | The ID of the Facebook Page account
        String postId = "1234567890_9876543210"; // String | The Facebook post ID
        try {
            GetFacebookPostReactions200Response result = apiInstance.getFacebookPostReactions(accountId, postId);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling AnalyticsApi#getFacebookPostReactions");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## getFacebookPostReactionsWithHttpInfo

> ApiResponse<GetFacebookPostReactions200Response> getFacebookPostReactions getFacebookPostReactionsWithHttpInfo(accountId, postId)
...
ApiResponse<[**GetFacebookPostReactions200Response**](GetFacebookPostReactions200Response.md)>
