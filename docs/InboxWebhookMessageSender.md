...
|**whatsappUsername** | **String** | WhatsApp only. User&#39;s WhatsApp username (e.g. &#x60;@jane&#x60;). Not a stable identifier, because users can change it. Useful for display, not recommended as an identity anchor.  |  [optional] |
