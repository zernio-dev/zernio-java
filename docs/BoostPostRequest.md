...
|**adSetName** | **String** | Exact name for the ad-group level this boost provisions. Omitted keeps the default &#x60;&lt;name&gt; - Ad Group&#x60;. Meta: ad set; TikTok, Pinterest, Google: ad group; X: line item; LinkedIn: the campaign under the campaign group. Ignored on the Meta attach shape. |  [optional] |
|**goal** | [**GoalEnum**](#GoalEnum) | Available goals vary by platform. Meta (Facebook/Instagram) and TikTok support all 7. LinkedIn supports all except app_promotion. X supports engagement, traffic, awareness, video_views, app_promotion. Pinterest and Google Ads support only engagement, traffic, awareness, video_views. |  |
...
|**locationTargetingType** | **GoogleLocationTargetingType** | Google only (400 elsewhere). Written on the campaign the boost creates. |  [optional] |
