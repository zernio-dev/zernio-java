...
> CreatePost200Response createPost(createPostRequest, idempotencyKey, xRequestId)
...
> ApiResponse<CreatePost200Response> createPost createPostWithHttpInfo(createPostRequest, idempotencyKey, xRequestId)
