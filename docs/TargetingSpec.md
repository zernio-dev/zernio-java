...
|------------ | ------------- | ------------- | -------------|
|**userOs** | **List&lt;String&gt;** | Meta only. Operating systems and version ranges, such as iOS_ver_14.0_and_above or Android. Emitted as user_os. May also be supplied inside targeting. |  [optional] |
|**userDevice** | **List&lt;String&gt;** | Meta only. Device models such as iPhone. Emitted as user_device. May also be supplied inside targeting. |  [optional] |
|**countries** | **List&lt;String&gt;** | ISO 3166-1 alpha-2 country codes (e.g. [&#39;US&#39;]). |  [optional] |
|**regions** | [**List&lt;CreateStandaloneAdRequestZipsInner&gt;**](CreateStandaloneAdRequestZipsInner.md) | Region/state targeting. &#x60;key&#x60; is the platform location ID from /v1/ads/targeting/search?dimension&#x3D;geo&amp;geoType&#x3D;region. An entry may also be that id as a plain string (&#x60;\&quot;20321\&quot;&#x60; is &#x60;{ key: \&quot;20321\&quot; }&#x60;). |  [optional] |
|**cities** | [**List&lt;TargetingSpecCitiesInner&gt;**](TargetingSpecCitiesInner.md) | City targeting. Optional &#x60;radius&#x60; + &#x60;distanceUnit&#x60; extend beyond the city limits; both must be set together or both omitted. &#x60;radius&#x60; is only honoured on platforms whose capability map allows city radius (Meta). An entry may also be the city id as a plain string (&#x60;\&quot;1006410\&quot;&#x60; is &#x60;{ key: \&quot;1006410\&quot; }&#x60;). |  [optional] |
...
|**industries** | **List&lt;String&gt;** | LinkedIn B2B only. Industry URN id fragments, or the full urn:li:industry:* URN from /v1/ads/targeting/search?dimension&#x3D;industry. |  [optional] |
|**companySizes** | **List&lt;String&gt;** | LinkedIn B2B only. Single-letter size codes (A to I), or the full urn:li:staffCountRange:* URN from /v1/ads/targeting/search?dimension&#x3D;companySize. |  [optional] |
|**seniorities** | **List&lt;String&gt;** | LinkedIn B2B only. Seniority URN id fragments, or the full urn:li:seniority:* URN from /v1/ads/targeting/search?dimension&#x3D;seniority. |  [optional] |
