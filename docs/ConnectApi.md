...
| [**assignGoogleBusinessLocationWithHttpInfo**](ConnectApi.md#assignGoogleBusinessLocationWithHttpInfo) | **POST** /v1/accounts/{accountId}/gmb-locations/assign | Assign Google Business Profile location to another profile |
...
| [**completeMetaAdsBusinessLoginWithHttpInfo**](ConnectApi.md#completeMetaAdsBusinessLoginWithHttpInfo) | **GET** /v1/connect/meta-ads/callback | Complete Meta business login |
...
| [**connectWordPressWithApplicationPasswordWithHttpInfo**](ConnectApi.md#connectWordPressWithApplicationPasswordWithHttpInfo) | **POST** /v1/connect/wordpress/token | Connect self-hosted WordPress with an application password |
...
| [**getGmbLocationsWithHttpInfo**](ConnectApi.md#getGmbLocationsWithHttpInfo) | **GET** /v1/accounts/{accountId}/gmb-locations | List Google Business Profile locations |
...
| [**getPageWebhookSubscriptionWithHttpInfo**](ConnectApi.md#getPageWebhookSubscriptionWithHttpInfo) | **GET** /v1/accounts/{accountId}/webhook-subscription | Read a Facebook Page&#39;s webhook subscription |
...
| [**getWordPressAuthUrlWithHttpInfo**](ConnectApi.md#getWordPressAuthUrlWithHttpInfo) | **GET** /v1/connect/wordpress | Get WordPress.com OAuth connect URL |
...
| [**listGoogleBusinessLocationsWithHttpInfo**](ConnectApi.md#listGoogleBusinessLocationsWithHttpInfo) | **GET** /v1/connect/googlebusiness/locations | List Google Business Profile locations |
...
| [**listSlackChannelsWithHttpInfo**](ConnectApi.md#listSlackChannelsWithHttpInfo) | **GET** /v1/connect/slack | List Slack channels for the channel picker |
...
| [**resyncPageWebhookSubscriptionWithHttpInfo**](ConnectApi.md#resyncPageWebhookSubscriptionWithHttpInfo) | **POST** /v1/accounts/{accountId}/webhook-subscription | Re-subscribe a Facebook Page to Zernio&#39;s webhooks |
...
| [**selectGoogleBusinessLocationWithHttpInfo**](ConnectApi.md#selectGoogleBusinessLocationWithHttpInfo) | **POST** /v1/connect/googlebusiness/select-location | Select Google Business Profile location |
...
| [**updateGmbLocationWithHttpInfo**](ConnectApi.md#updateGmbLocationWithHttpInfo) | **PUT** /v1/accounts/{accountId}/gmb-locations | Update Google Business Profile location |
...
public class Example {
    public static void main(String[] args) {
        ...
        String accountId = "accountId_example"; // String | A source connected Google Business Profile account whose OAuth grant is reused.
...
> void completeMetaAdsBusinessLogin(state, code, error)
...
public class Example {
    public static void main(String[] args) {
        ...
        ConnectApi apiInstance = new ConnectApi(defaultClient);
        String state = "ENCRYPTED_STATE"; // String | Authenticated state from the initial connectAds response.
        String code = "code_example"; // String | Single-use authorization code returned by Meta.
        String error = "error_example"; // String | Meta authorization error when the user declines the dialog.
        try {
            apiInstance.completeMetaAdsBusinessLogin(state, code, error);
        } catch (ApiException e) {
            System.err.println("Exception when calling ConnectApi#completeMetaAdsBusinessLogin");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## completeMetaAdsBusinessLoginWithHttpInfo

> ApiResponse<Void> completeMetaAdsBusinessLogin completeMetaAdsBusinessLoginWithHttpInfo(state, code, error)
...
public class Example {
    public static void main(String[] args) {
        ...
        String error = "error_example"; // String | Meta authorization error when the user declines the dialog.
        try {
            ApiResponse<Void> response = apiInstance.completeMetaAdsBusinessLoginWithHttpInfo(state, code, error);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
        } catch (ApiException e) {
            System.err.println("Exception when calling ConnectApi#completeMetaAdsBusinessLogin");
...
> ConnectAds200Response connectAds(platform, profileId, loginMode, permissionLevel, pageId, accountId, redirectUrl, headless, force, adAccountId, adAccountIds)
...
| **loginMode** | **String**| Meta ads authorization mode. Business login is opt-in for Facebook and Instagram; classic preserves the posting-account flow. | [optional] [default to classic] [enum: classic, business] |
| **permissionLevel** | **String**| Business login only. Ad-account permission the connection&#39;s system user will hold. &#x60;full&#x60; asks the owner for Full control (MANAGE; required to create pixels and other account-level assets through Zernio). &#x60;advertise&#x60; asks for Manage campaigns (ADVERTISE), enough for campaigns, ad sets, creatives, ads, media and reporting, for owners who will not grant billing-level control to an integration. Either way Meta only lets a business admin complete the grant. 503 if the advertise configuration is not set up. | [optional] [default to full] [enum: full, advertise] |
...
> ApiResponse<ConnectAds200Response> connectAds connectAdsWithHttpInfo(platform, profileId, loginMode, permissionLevel, pageId, accountId, redirectUrl, headless, force, adAccountId, adAccountIds)
...
> ConnectWhatsAppEmbeddedSignup200Response connectWhatsAppEmbeddedSignup(connectWhatsAppEmbeddedSignupRequest, xConnectToken)
...
public class Example {
    public static void main(String[] args) {
        ...
        String xConnectToken = "xConnectToken_example"; // String | Connect token issued by the hosted signup flow, accepted instead of an API key.
        try {
...
> ApiResponse<ConnectWhatsAppEmbeddedSignup200Response> connectWhatsAppEmbeddedSignup connectWhatsAppEmbeddedSignupWithHttpInfo(connectWhatsAppEmbeddedSignupRequest, xConnectToken)
...
ApiResponse<[**ConnectWhatsAppEmbeddedSignup200Response**](ConnectWhatsAppEmbeddedSignup200Response.md)>
...
> ConnectWordPressWithApplicationPassword200Response connectWordPressWithApplicationPassword(connectWordPressWithApplicationPasswordRequest)
...
public class Example {
    public static void main(String[] args) {
        ...
        ConnectApi apiInstance = new ConnectApi(defaultClient);
        ConnectWordPressWithApplicationPasswordRequest connectWordPressWithApplicationPasswordRequest = new ConnectWordPressWithApplicationPasswordRequest(); // ConnectWordPressWithApplicationPasswordRequest | 
        try {
            ...
            System.err.println("Exception when calling ConnectApi#connectWordPressWithApplicationPassword");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## connectWordPressWithApplicationPasswordWithHttpInfo

> ApiResponse<ConnectWordPressWithApplicationPassword200Response> connectWordPressWithApplicationPassword connectWordPressWithApplicationPasswordWithHttpInfo(connectWordPressWithApplicationPasswordRequest)
...
ApiResponse<[**ConnectWordPressWithApplicationPassword200Response**](ConnectWordPressWithApplicationPassword200Response.md)>
...
> GetConnectUrl200Response getConnectUrl(platform, profileId, redirectUrl, headless, loginMethod, onboarding, signup, brandName, primaryColor, language)
...
public class Example {
    public static void main(String[] args) {
        ...
        ConnectApi apiInstance = new ConnectApi(defaultClient);
        String platform = "facebook"; // String | Social media platform to connect. `snapchat` is a closed beta with no public release date: it returns 403 `PLATFORM_BETA_RESTRICTED` until the account is approved.
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **platform** | **String**| Social media platform to connect. &#x60;snapchat&#x60; is a closed beta with no public release date: it returns 403 &#x60;PLATFORM_BETA_RESTRICTED&#x60; until the account is approved. | [enum: facebook, instagram, linkedin, twitter, tiktok, youtube, threads, reddit, pinterest, bluesky, googlebusiness, telegram, snapchat, discord, slack, whatsapp] |
...
| **language** | **String**| Hosted signup page only (&#x60;signup&#x3D;hosted&#x60;, WhatsApp): language of the page and its follow-along guide. Explainer videos stay in English. Default &#x60;en&#x60;. Rejected without &#x60;signup&#x3D;hosted&#x60;. | [optional] [enum: en, es, pt-BR] |
...
> ApiResponse<GetConnectUrl200Response> getConnectUrl getConnectUrlWithHttpInfo(platform, profileId, redirectUrl, headless, loginMethod, onboarding, signup, brandName, primaryColor, language)
...
> GetPageWebhookSubscription200Response getPageWebhookSubscription(accountId)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling ConnectApi#getPageWebhookSubscription");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## getPageWebhookSubscriptionWithHttpInfo

> ApiResponse<GetPageWebhookSubscription200Response> getPageWebhookSubscription getPageWebhookSubscriptionWithHttpInfo(accountId)
...
ApiResponse<[**GetPageWebhookSubscription200Response**](GetPageWebhookSubscription200Response.md)>
...
> GetWhatsAppSdkConfig200Response getWhatsAppSdkConfig(xConnectToken)
...
> ApiResponse<GetWhatsAppSdkConfig200Response> getWhatsAppSdkConfig getWhatsAppSdkConfigWithHttpInfo(xConnectToken)
...
> GetWordPressAuthUrl200Response getWordPressAuthUrl(profileId, redirectUrl)
...
public class Example {
    public static void main(String[] args) {
        ...
        ConnectApi apiInstance = new ConnectApi(defaultClient);
        String profileId = "profileId_example"; // String | Your Zernio profile ID (get from /v1/profiles).
        String redirectUrl = "redirectUrl_example"; // String | Custom redirect after connection. Must be an absolute http(s) URL or custom app scheme such as `myapp://callback`; relative and unsafe URLs return 400.
        try {
            GetWordPressAuthUrl200Response result = apiInstance.getWordPressAuthUrl(profileId, redirectUrl);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling ConnectApi#getWordPressAuthUrl");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## getWordPressAuthUrlWithHttpInfo

> ApiResponse<GetWordPressAuthUrl200Response> getWordPressAuthUrl getWordPressAuthUrlWithHttpInfo(profileId, redirectUrl)
...
ApiResponse<[**GetWordPressAuthUrl200Response**](GetWordPressAuthUrl200Response.md)>
...
> ListSlackChannels200Response listSlackChannels(profileId, pendingDataToken, accountId, redirectUrl)
...
public class Example {
    public static void main(String[] args) {
        ...
        ConnectApi apiInstance = new ConnectApi(defaultClient);
        String profileId = "profileId_example"; // String | Zernio profile the channel account will belong to. Must match the profile the OAuth flow was started on when `pendingDataToken` is used.
        String pendingDataToken = "pendingDataToken_example"; // String | Nonce from the OAuth redirect (first connect).
        String accountId = "accountId_example"; // String | Existing active Slack account (yours or a team member's) whose workspace token is reused.
        URI redirectUrl = new URI(); // URI | Start-OAuth mode only: where to send the user after the connect completes. `redirectUrl` is accepted as an alias.
        try {
            ListSlackChannels200Response result = apiInstance.listSlackChannels(profileId, pendingDataToken, accountId, redirectUrl);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling ConnectApi#listSlackChannels");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
| **redirectUrl** | **URI**| Start-OAuth mode only: where to send the user after the connect completes. &#x60;redirectUrl&#x60; is accepted as an alias. | [optional] |
...
## listSlackChannelsWithHttpInfo

> ApiResponse<ListSlackChannels200Response> listSlackChannels listSlackChannelsWithHttpInfo(profileId, pendingDataToken, accountId, redirectUrl)
...
ApiResponse<[**ListSlackChannels200Response**](ListSlackChannels200Response.md)>
...
> ResyncPageWebhookSubscription200Response resyncPageWebhookSubscription(accountId)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling ConnectApi#resyncPageWebhookSubscription");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
## resyncPageWebhookSubscriptionWithHttpInfo

> ApiResponse<ResyncPageWebhookSubscription200Response> resyncPageWebhookSubscription resyncPageWebhookSubscriptionWithHttpInfo(accountId)
...
ApiResponse<[**ResyncPageWebhookSubscription200Response**](ResyncPageWebhookSubscription200Response.md)>
