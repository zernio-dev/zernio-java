...
|**actionBreakdowns** | **String** | Comma-separated Graph action breakdowns (e.g. action_type,action_destination). Pass &#x60;none&#x60; to clear Meta&#39;s default action_type breakdown, needed for some non-action breakdowns such as instagram_ads_follow_type. |  [optional] |
