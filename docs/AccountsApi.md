...
| [**getAccountPostsWithHttpInfo**](AccountsApi.md#getAccountPostsWithHttpInfo) | **GET** /v1/accounts/{accountId}/posts | List posts for an account |
...
> GetAccountPosts200Response getAccountPosts(accountId, excludeUnlisted)
...
public class Example {
    public static void main(String[] args) {
        ...
        AccountsApi apiInstance = new AccountsApi(defaultClient);
        String accountId = "accountId_example"; // String | 
        Boolean excludeUnlisted = true; // Boolean | YouTube only. When `true`, excludes unlisted and private videos from the response. Has no effect on other platforms.
        try {
...
|------------- | ------------- | ------------- | -------------|
| **accountId** | **String**|  | |
| **excludeUnlisted** | **Boolean**| YouTube only. When &#x60;true&#x60;, excludes unlisted and private videos from the response. Has no effect on other platforms. | [optional] |
...
> ApiResponse<GetAccountPosts200Response> getAccountPosts getAccountPostsWithHttpInfo(accountId, excludeUnlisted)
